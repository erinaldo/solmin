...
Public Class rptMonthly_SC_OP
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CTLReporte_Monthly.rptMonthly_SC_OP.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptMonthly_SC_OP
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptMonthly_SC_OP = New rptMonthly_SC_OP
        rpt.Site = Me.Site
        Return rpt
    End Function
