...
Public Class rptMonthly_SC_FA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CTLReporte_Monthly.rptMonthly_SC_FA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptMonthly_SC_FA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptMonthly_SC_FA = New rptMonthly_SC_FA
        rpt.Site = Me.Site
        Return rpt
    End Function
