...
Public Class rptMonthly_SC_NA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CTLReporte_Monthly.rptMonthly_SC_NA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptMonthly_SC_NA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptMonthly_SC_NA = New rptMonthly_SC_NA
        rpt.Site = Me.Site
        Return rpt
    End Function
