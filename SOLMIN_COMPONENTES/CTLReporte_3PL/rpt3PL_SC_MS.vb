...
Public Class rpt3PL_SC_MS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CTLReporte_3PL.rpt3PL_SC_MS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt3PL_SC_MS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt3PL_SC_MS = New rpt3PL_SC_MS
        rpt.Site = Me.Site
        Return rpt
    End Function
