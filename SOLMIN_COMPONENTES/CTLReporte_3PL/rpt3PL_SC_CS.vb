...
Public Class rpt3PL_SC_CS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CTLReporte_3PL.rpt3PL_SC_CS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt3PL_SC_CS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt3PL_SC_CS = New rpt3PL_SC_CS
        rpt.Site = Me.Site
        Return rpt
    End Function
