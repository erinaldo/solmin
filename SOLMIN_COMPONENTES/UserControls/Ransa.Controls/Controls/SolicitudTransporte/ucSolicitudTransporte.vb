...
Public Class ucSolicitudTransporte
    ...
    Private oSeguridad As Seguridad = New Seguridad(_pUsuario)
    ...
    Private objNCRRSR As Int32 = 0
    Private objNCRRCT As Int32 = 0
    ...
    Public Sub Activated()
        ...
        If gintEstado = 2 Then
            ...
            objNCRRSR = objFormBuscarOrdenServicio.objOrdenServicioTransporteBE.NCRRSR
            objNCRRCT = objFormBuscarOrdenServicio.objOrdenServicioTransporteBE.NCRRCT
    ...
    Public Sub pInicializar()
        Try
            ...
            Me.Cargar_Compania()
            cmbCompania.HabilitarCompaniaActual(_pCompaniaActual)
    ...
    Private Sub Cargar_Combos()
        ...
        Dim obj_Logica_Servicio As New ServicioTransporte_BLL
        Dim obj_Entidad_Servicio As New ServicioTransporte
        Dim obj_Logica_Mercaderia As New MercaderiaTransportes_BLL
        Dim obj_Entidad_Mercaderia As New MercaderiaTransportes
...
#End Region
    ...
    Private Sub Nuevo_Registro()
        ...
        Try
            ...
            objEntidad.CLCLOR = Me.ctlLocalidadOrigen.Codigo
            objEntidad.TDRCOR = Me.txtDireccionLocalidadCarga.Text
            objEntidad.CLCLDS = Me.ctlLocalidadDestino.Codigo
            ...
            objEntidad = objSolicitudTransporte.Registrar_Solicitud_Transporte(objEntidad)
            If objEntidad.NCSOTR = "0" Then
                HelpClass.ErrorMsgBox()
                Exit Sub
            Else
    ...
    Private Function validar_inputs() As Boolean
        ...
        If Me.gEnum_Mantenimiento = MANTENIMIENTO.EDITAR Then
            ...
            End If
        End If
        If ctlLocalidadOrigen.NoHayCodigo = True Then
        ...
        End If
        If ctlLocalidadDestino.NoHayCodigo = True Then
    ...
    Private Sub Estado_Controles(ByVal lbool_Estado As Boolean)
        ...
        'Me.btnNuevoOS.Enabled = lbool_Estado
        Me.btnNuevoOS.Enabled = False
        Me.btnLimpiarOS.Enabled = lbool_Estado
    ...
    Private Sub Cargar_Datos_Grilla()
        ...
        Me.HeaderDatos.ValuesPrimary.Heading = " Nro : " & objEntidad.NCSOTR & " | Clte : " + txtCliente.pRazonSocial & " | Ori : " & Me.ctlLocalidadOrigen.Descripcion & " | Dest : " & Me.ctlLocalidadDestino.Descripcion
    ...
    Private Sub Cargar_Detalle_Solicitud()
        ...
        For Each obj_Entidad As ClaseGeneral In objSolicitudTransporte.Obtener_Detalle_Solicitud_Asignada(objEntidad)
            ...
            If obj_Entidad.NCOREG <> 0 Then
                dwvrow.Cells(1).Value = My.Resources.excel1 ' My.Resources.button_ok1
            Else
                dwvrow.Cells(1).Value = My.Resources.excel1 ' My.Resources.Nada_1
            End If
    ...
    Private Sub Imprimir2(ByVal ListaParametros As List(Of String))
        ...
        HelpClass.CrystalReportTextObject(objCrep, "lblUsuario", _pUsuario)
    ...
    Private Sub ckbRangoFechas_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ckbRangoFechas.CheckedChanged
        ...
        Me.KryptonCheckBox3.Enabled = ckbRangoFechas.Checked
        Me.KryptonCheckBox3.Checked = False 'ckbRangoFechas.Checked
    ...
    Private Sub Validar_Acceso_Opciones_Usuario()
        ...
        objParametro.Add("MMCAPL", "ST") 'MainModule.getAppSetting("System_prefix"))
        objParametro.Add("MMCUSR", _pUsuario)
        objParametro.Add("MMNPVB", "frmSolicitudTransporte") 'Me.Name.Trim)
        ...
        If objEntidad.STSOP3 = "" Then
            ...
            Me.btnNuevoOS.Visible = False
            Me.tsmNuevoOS.Visible = False
        Else
    ...
    Private Sub btnServicioAlmacen_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnServicioAlmacen.Click
        ...
        '        .ProcesoEjecutar = 0
        '        If Me.ctlLocalidadOrigen.Codigo.ToString.Trim = "" Then
        '            .ObjetoServicio_Entidad_Guia.CLCLOR = 0
        '        Else
        '            .ObjetoServicio_Entidad_Guia.CLCLOR = CType(Me.ctlLocalidadOrigen.Codigo, Double)
        '        End If
        '        If Me.ctlLocalidadDestino.Codigo.ToString.Trim = "" Then
        '            .ObjetoServicio_Entidad_Guia.CLCLDS = 0
        '        Else
        '            .ObjetoServicio_Entidad_Guia.CLCLDS = CType(Me.ctlLocalidadDestino.Codigo, Double)
        '        End If
        ...
        '        Dim obj_Logica_Guia As New SOLMIN_ST.NEGOCIO.mantenimientos.GuiaTransportista_BLL
        '        Dim obj_Entidad_Guia_Transporte As New SOLMIN_ST.ENTIDADES.mantenimientos.GuiaTransportista
        ...
        '            Dim obeSeguimientoGPS As New SOLMIN_ST.ENTIDADES.SeguimientoGPS
    ...
    Private Sub btnNuevoOS_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNuevoOS.Click
        NuevoOS()
        Activated()
    End Sub
    ...
    Private Sub ckbUsuarioCreador_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ckbUsuarioCreador.CheckedChanged
        If ckbUsuarioCreador.Checked = True Then
            cmbUsuarioCreador.pObtenerUsuario(_pUsuario)
    ...
    Private Sub KryptonCheckBox1_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles KryptonCheckBox3.CheckedChanged
        If ckbRangoFechas.Enabled = True Then
            Me.dtpHora_Ini.Enabled = KryptonCheckBox3.Checked
            Me.dtpHora_Ini.Value = Date.Parse("08:00:00")
            Me.dtpHora_Fin.Enabled = KryptonCheckBox3.Checked
