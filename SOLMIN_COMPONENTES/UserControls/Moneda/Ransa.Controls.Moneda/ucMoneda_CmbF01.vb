...
#Region " Atributos "
    ...
    'Private pMoneda As TD_Moneda = New Ransa.TypeDef.Moneda.TD_Moneda
    Private pMoneda As TD_Moneda = New Moneda.TD_Moneda
...
#Region " Funciones y Procedimientos "
    Private Function pObtenerMoneda(ByVal Codigo As String) As Boolean
        ...
        Dim objTemp As TD_Moneda = cMoneda.Obtener(objSqlManager, Codigo, strMensajeError)
    ...
    Public Function pObtenerMonedaAbreiatura(ByVal Abreviatura As String) As Boolean
        Dim blnResultado As Boolean = False
        Dim objTemp As TD_Moneda = cMoneda.ObtenerPorAbreviatura(objSqlManager, Abreviatura, strMensajeError)
        If strMensajeError <> "" Then
            RaiseEvent ErrorMessage(strMensajeError)
        Else
            If objTemp.pCMNDA1_Codigo <> "" Then
...
#Region " Eventos "
    Private Sub ucTipoAyuda_CmbF01_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        'Dim dtTemp As DataTable = cMoneda.fdtListar_Moneda_L01(objSqlManager, strMensajeError)
        Dim dtTemp As DataTable = cMoneda.fdtListar_Moneda_L01(objSqlManager, strMensajeError)
