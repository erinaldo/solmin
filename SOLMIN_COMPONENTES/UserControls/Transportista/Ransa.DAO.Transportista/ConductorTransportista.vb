...
Public Class cConductorTransportista
...
#Region " Métodos "
    ...
    Public Function Obtener(ByVal ConductorPK As TD_ConductorTransportistaPK) As TD_Obj_ConductorTransportista
        Dim objParametros As Parameter = New Parameter
        Dim oConductor As TD_Obj_ConductorTransportista = New TD_Obj_ConductorTransportista
        ' Ingresamos los parametros del Procedure 
        With objParametros
            .Add("IN_CCMPN", ConductorPK.pCCMPN_Compania)
            .Add("IN_CBRCNT", ConductorPK.pCBRCNT_Brevete)
            .Add("IN_NRUCTR", ConductorPK.pNRUCTR_RucTransportista)
            .Add("IN_CPLNDV", ConductorPK.pPlanta)
            .Add("IN_CPLNDV", ConductorPK.pCDVSN)
        ...
        'Dim dtTemp As DataTable = oSqlManager.ExecuteDataTable("SP_SOLMIN_CONDUCTOR_X_TRANSPORTISTA_RZST08_OBJ", objParametros)
        dtTemp = oSqlManager.ExecuteDataTable("SP_SOLMIN_CONDUCTOR_X_TRANSPORTISTA_RZST08_OBJ_V2", objParametros)

        'Dim htResultado As Hashtable
        'htResultado = oSqlManager.ParameterCollection
        'sErrorMessage = htResultado("OU_MSGERR")
        If dtTemp.Rows.Count = 0 Then
            sErrorMessage = "Conductor  no se encuentra asignado al transportista"
        End If
        ...
        '                    "Tipo de Operación : << Llamada Procedimiento : SP_SOLMIN_CONDUCTOR_X_TRANSPORTISTA_RZST08_OBJ >> " & vbNewLine & _
    ...
    ''' </summary>
    Public Function Listar(ByVal TD_Filtro As TD_Qry_ConductorTransportista_L01, ByRef intNroTotalPaginas As Int32) As DataTable
        ...
        With objParametros
            ...
            .Add("IN_CPLNDV", TD_Filtro.pPlanta)
            .Add("IN_CDVSN", TD_Filtro.pCDVSN)
        ...
        'dtTemp = oSqlManager.ExecuteDataTable("SP_SOLMIN_CONDUCTOR_X_TRANSPORTISTA_RZST08_L01", objParametros)
        ds = oSqlManager.ExecuteDataSet("SP_SOLMIN_CONDUCTOR_X_TRANSPORTISTA_RZST08_L01_V2", objParametros)
        ...
        '                      "Tipo de Operación : << Llamada Procedimiento : SP_SOLMIN_CONDUCTOR_X_TRANSPORTISTA_RZST08_L01 >> " & vbNewLine & _
        '                      "Motivo del Error : " & ex.Message
        'Finally
        '    objParametros = Nothing
        'End Try
