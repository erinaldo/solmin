...
Public Class ucConductor_FConductor
...
#End Region
#Region " Eventos "
    Sub New(ByVal Filtro As TD_Qry_Conductor_L01)
    ...
    Sub New(ByVal Filtro As TD_Qry_Conductor_L01, ByVal DataSource As DataTable, ByVal iTPag As Integer)
        ' Llamada necesaria para el Diseñador de Windows Forms.
        InitializeComponent()
        ' Agregue cualquier inicialización después de la llamada a InitializeComponent().
        With Filtro
    ...
    Private Sub dgConductor_SalirDobleClick(ByVal Conductor As TypeDef.Transportista.TD_Inf_Conductor_L01) Handles dgConductor.SalirDobleClick
