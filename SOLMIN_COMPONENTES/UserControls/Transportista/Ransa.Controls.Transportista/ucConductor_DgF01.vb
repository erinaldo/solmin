...
Public Class ucConductor_DgF01
#Region " Definición Eventos "
    Public Event DataLoadCompleted(ByVal Conductor As TD_Inf_Conductor_L01)
    Public Event TableWithOutData()
    Public Event CurrentRowChanged(ByVal Conductor As TD_Inf_Conductor_L01)
    ...
    Public Event SalirDobleClick(ByVal Conductor As TD_Inf_Conductor_L01)
#End Region
#Region " Tipo "
...
#Region " Atributos "
    ...
    '-------------------------------------------------
    Private oConductor As cConductor = New Ransa.DAO.Transportista.cConductor
    '-------------------------------------------------
    ' Almacenamiento de Información
    '-------------------------------------------------
    Private oQry_Conductor_L01 As TD_Qry_Conductor_L01 = New Ransa.TypeDef.Transportista.TD_Qry_Conductor_L01
    Private oInf_Conductor As TD_Inf_Conductor_L01 = New Ransa.TypeDef.Transportista.TD_Inf_Conductor_L01
...
#Region " Propiedades "
    ...
    Public ReadOnly Property pSeleccion() As TD_Inf_Conductor_L01
        Get
...
#End Region
#Region " Métodos "
    Public Sub pActualizar(ByVal objFiltro As TD_Qry_Conductor_L01)
    ...
    Public Sub LoadDataSource(ByVal objFiltro As TD_Qry_Conductor_L01, ByVal DataSource As DataTable, ByVal iTPag As Integer)
        ' Seteamos los valores que hasta ese momento se ha ingresado 
        oQry_Conductor_L01.pCCMPN_Compania = objFiltro.pCCMPN_Compania
        oQry_Conductor_L01.pCBRCNT_Brevete = objFiltro.pCBRCNT_Brevete
        oQry_Conductor_L01.pNombreApellidoChofer = objFiltro.pNombreApellidoChofer
