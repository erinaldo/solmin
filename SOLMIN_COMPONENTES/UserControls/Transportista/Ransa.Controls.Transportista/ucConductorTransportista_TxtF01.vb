...
Public Class ucConductorTransportista_TxtF01
...
#Region " Atributos "
    ...
    '-------------------------------------------------
    Private oConductor As cConductorTransportista
    '-------------------------------------------------
    ' Almacenamiento de Información
    '-------------------------------------------------
    Private oInf_Conductor As TD_Inf_ConductorTransportista_L01 = New TD_Inf_ConductorTransportista_L01
    Private oQry_Conductor As TD_Qry_ConductorTransportista_L01 = New TD_Qry_ConductorTransportista_L01
    '-------------------------------------------------
    ...
    ' Datos de Seguridad 
    '-------------------------------------------------
    Private oConductorPK As TD_ConductorTransportistaPK = New TD_ConductorTransportistaPK
...
#Region " Funciones y Procedimientos "
    Private Function fbBuscar() As Boolean
        ...
        oQry_Conductor.pPlanta = oConductorPK.pPlanta
        oQry_Conductor.pCDVSN = oConductorPK.pCDVSN
        ...
        Else
            ...
            Else
                ...
                Else
                    ...
                    Dim fbusqueda As ucConductorTransportista_FConductor = New ucConductorTransportista_FConductor(oQry_Conductor, dtTemp, iTPag)
    ...
    Private Function pObtenerConductor() As Boolean
        ...
        If oConductorPK.pCBRCNT_Brevete <> "" Then
            ...
            Dim objConductor As TD_Obj_ConductorTransportista = oConductor.Obtener(oConductorPK)

            If oConductor.ErrorMessage <> "" Then
                MessageBox.Show(oConductor.ErrorMessage, "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Warning)
            Else
        ...
        Else
            ...
            Else
                txtConductor.Text = ""
                MessageBox.Show("Conductor no existe.", "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Warning)
            End If
        End If
        Return blnResultado
    End Function
...
#Region " Métodos "
    Sub New()
        ...
        oConductor = New cConductorTransportista
    End Sub

    Public Sub pCargar(ByVal Conductor As TD_ConductorTransportistaPK)
        ...
        oConductorPK.pPlanta = Conductor.pPlanta
        oConductorPK.pCDVSN = Conductor.pCDVSN
