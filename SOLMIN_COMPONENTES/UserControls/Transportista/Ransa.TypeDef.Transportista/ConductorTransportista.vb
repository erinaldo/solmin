...
Public Class TD_ConductorTransportistaPK
#Region " Atributos "
...
''' </summary>
<StructLayout(LayoutKind.Sequential)> _
Public Class TD_Obj_ConductorTransportista
#Region " Atributos "
    Public pCCMPN_Compania As String = ""
    Public pCBRCNT_Brevete As String = ""
...
''' </summary>
<StructLayout(LayoutKind.Sequential)> _
Public Class TD_Inf_ConductorTransportista_L01
#Region " Atributos "
    Public pCCMPN_Compania As String = ""
    Public pCBRCNT_Brevete As String = ""
    Public pTNMCMC_NombreChofer As String = ""
...
''' </summary>
<StructLayout(LayoutKind.Sequential)> _
Public Class TD_Qry_ConductorTransportista_L01
#Region " Atributos "
    Public pCCMPN_Compania As String = ""
    Public pCBRCNT_Brevete As String = ""
