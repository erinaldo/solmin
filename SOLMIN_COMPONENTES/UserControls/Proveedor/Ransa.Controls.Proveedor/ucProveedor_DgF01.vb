...
#Region " Atributos "
    ...
    'Private TD_Filtro As TD_ProveedorL01 = New Ransa.TypeDef.Proveedor.TD_ProveedorL01
    'Private TD_ProveedorSelec As TD_InfBas_Proveedor = New Ransa.TypeDef.Proveedor.TD_InfBas_Proveedor
    Private TD_Filtro As TD_ProveedorL01 = New Proveedor.TD_ProveedorL01
    Private TD_ProveedorSelec As TD_InfBas_Proveedor = New Proveedor.TD_InfBas_Proveedor
...
#Region " Funciones y Procedimientos "
    Private Sub pCargarInformacion()
        strMensajeError = ""
        blnCargando = True
        dgProveedor.DataSource = cProveedor.fdtListar_Proveedor_L01(objSqlManager, TD_Filtro, intNroTotalPaginas, strMensajeError)
        blnCargando = False
