...
Public Class rptOperacionSASAT
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Ransa.Controls.ServicioOperacion.rptOperacionSASAT.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptOperacionSASAT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptOperacionSASAT = New rptOperacionSASAT()
        rpt.Site = Me.Site
        Return rpt
    End Function
