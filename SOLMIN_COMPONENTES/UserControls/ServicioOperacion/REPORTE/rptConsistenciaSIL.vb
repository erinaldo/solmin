...
Public Class rptConsistenciaSIL
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Ransa.Controls.ServicioOperacion.rptConsistenciaSIL.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptConsistenciaSIL
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptConsistenciaSIL = New rptConsistenciaSIL()
        rpt.Site = Me.Site
        Return rpt
    End Function
