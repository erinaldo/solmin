...
DROP PROCEDURE DC@DESLIB.SP_SOLMIN_SA_SERVICIOS_DETALLE_RZSC31_L03
GO
CREATE PROCEDURE DC@DESLIB.SP_SOLMIN_SA_SERVICIOS_DETALLE_RZSC31_L03(
...
BEGIN ATOMIC
	...
	DECLARE WK_SQL  	VARCHAR(6000)	DEFAULT '';
	...
	SET WK_SQL = '	Select	CMRCLR, TMRCD2, CMRCD, CTPOAT, NORDSR, NSLCSR, CTPALM, CALMC, QTRMC, CUNCN5, QTRMP, CUNPS5, NGUIRN, SESTRG
					From	SESSION.tmpMercaderia';	
	-- Realizamos la preparación de la Consulta para ser ejecutada
	PREPARE S2 FROM WK_SQL;
	OPEN CU_02;

END

GO
GRANT ALL PRIVILEGES ON PROCEDURE SP_SOLMIN_SA_SERVICIOS_DETALLE_RZSC31_L03 TO PUBLIC