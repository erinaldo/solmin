...
#Region " Atributos "
    ...
    '-------------------------------------------------
    Private fServF01 As ucServicios_FServF01 = Nothing
    Private TD_Filtro As TD_Qry_Servicios_Adquiridos_L01 = New Ransa.TypeDef.Servicios.TD_Qry_Servicios_Adquiridos_L01
    Private TD_InfServF03 As TD_Inf_Servicio_F03 = New Ransa.TypeDef.Servicios.TD_Inf_Servicio_F03
    ...
    Private oTD_InfServF01 As TD_Inf_Servicio_F01 = New Ransa.TypeDef.Servicios.TD_Inf_Servicio_F01
    '-------------------------------------------------
...
#Region " Funciones y Procedimientos "
    Private Sub pCargarInformacion()
        ...
        strMensajeError = ""
        blnCargando = True
        dgServicio.DataSource = cServicios.fdtListar_Servicios_L01(objSqlManager, TD_Filtro, intNroTotalPaginas, strMensajeError)
        blnCargando = False
        ...
        Else
            If dgServicio.RowCount > 0 Then
                With TD_InfServF03
                    ...
                    .pFECINI_Inicio = dgServicio.CurrentRow.Cells("M_FECINI").Value
                    .pFECFIN_Final = dgServicio.CurrentRow.Cells("M_FECFIN").Value
    ...
    Private Sub pDisposeFormServF01(ByVal StatusProceso As Boolean)
        ...
        RemoveHandler fServF01.pDisposeForm, AddressOf pDisposeFormServF01
        fServF01.Dispose()
        fServF01 = Nothing
        If StatusProceso Then Call pRefrescar()
    End Sub
#End Region
#Region " Eventos "
    Private Sub btnAgregar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAgregar.Click
        If cbxPlanta.SelectedIndex < 0 Then
            ...
            Exit Sub
        End If
        ' Iniciamos el proceso, siempre que tenga ingresado el Cliente
        If TD_Filtro.pCCLNT_CodigoCliente <> 0 Then
            ' bloqueo las opciones de Gestión
            btnAgregar.Enabled = False
            btnModificar.Enabled = False
            btnEliminar.Enabled = False
            ' Registramos los parametros necesario
            With oTD_InfServF01
                .pClear()
                ...
                .pFECFIN_Final = Date.Now
                .pFECINI_Inicio = Date.Now
                .pSTPODP_TipoSistAlm = TD_Filtro.pSTPODP_TipoSistAlm
                .pUsuario = TD_Filtro.pUsuario
            End With
            ' Realizamos la carga del formulario y el control de los eventos
            fServF01 = New ucServicios_FServF01(oTD_InfServF01)
            AddHandler fServF01.pDisposeForm, AddressOf pDisposeFormServF01
            fServF01.Show()
        End If
    End Sub
    ...
    Private Sub btnModificar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnModificar.Click
        ...
        If TD_InfServF03.pNOPRCN_Operacion <> 0 Then
            ...
            With oTD_InfServF01
                ...
                .pFECINI_Inicio = TD_InfServF03.pFECINI_Inicio
                .pFECFIN_Final = TD_InfServF03.pFECFIN_Final
    ...
    Private Sub btnEliminar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEliminar.Click
        If dgServicio.RowCount <= 0 Then
            ...
            Exit Sub
        End If
        If MessageBox.Show("¿ Desea eliminar la Operación Seleccionada ?", "Eliminar:", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
            ...
            With oServAdquPK
                ...
                If cServicios.EliminarServicioAdquirido(objSqlManager, oServAdquPK, TD_Filtro.pUsuario, strStatus, strMensajeError) Then
