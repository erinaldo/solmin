...
#Region " Atributos "
    ...
    Private TD_Filtro As TD_Qry_Servicio_Bulto_F01 = New Ransa.TypeDef.Servicios.TD_Qry_Servicio_Bulto_F01
    Private TD_BultoActual As TD_Inf_Servicio_Bulto_F01 = New Ransa.TypeDef.Servicios.TD_Inf_Servicio_Bulto_F01
    '-------------------------------------------------
...
#Region " Funciones y Procedimientos "
    ...
    Private Sub pCargarInformacion()
        If TD_Filtro.pCCLNT_CodigoCliente <> 0 Then
            ...
            oOperacionPK.pCCMPN_Compania = TD_Filtro.pCCMPN_Compania
            oOperacionPK.pCDVSN_Division = TD_Filtro.pCDVSN_Division
            oOperacionPK.pCPLNDV_Planta = TD_Filtro.pCPLNDV_Planta
            strMensajeError = ""
            blnCargando = True
            dgWayBill.DataSource = cServicios.fdtServicios_Detalle_L01(objSqlManager, oOperacionPK, strMensajeError)
            blnCargando = False
    ...
    Private Sub pWaybills_Registrar()
        ...
        With oTemp
            ...
            .pCPLNDV_Planta = TD_Filtro.pCPLNDV_Planta
            ...
            End Select
            If blnOnLine Then
                If Not cServicios.AgregarDetalleServicio(objSqlManager, oTemp, TD_Filtro.pUsuario, strMensajeError) Then
                    RaiseEvent ErrorMessage(strMensajeError)
                    txtCodigo.SelectAll()
                    Exit Sub
                End If
    ...
    Private Sub pWayBills_Cargar(ByVal oTemp As TD_Qry_Servicio_Bulto_F01)
        Dim dtTemp As DataTable = cServicios.fdtServicios_Detalle_L02(objSqlManager, oTemp, strMensajeError)
...
#Region " Eventos "
    ...
    Private Sub btnEliminar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEliminar.Click
        ...
        If blnOnLine Then
            ...
            cServicios.EliminarDetalleServicio(objSqlManager, oTemp, TD_Filtro.pUsuario, strMensajeError)
            If strMensajeError <> "" Then
                RaiseEvent ErrorMessage(strMensajeError)
            Else
