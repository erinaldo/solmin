...
Public Class urAlmacenaje_F01
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Ransa.Rpt.Servicios.urAlmacenaje_F01.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedurAlmacenaje_F01
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As urAlmacenaje_F01 = New urAlmacenaje_F01
        rpt.Site = Me.Site
        Return rpt
    End Function
