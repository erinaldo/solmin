...
Public Class ucPlantaDeEntrega
...
#Region " Propiedades "
    ...
    Private _CodClienteTercero As Double
...
#Region " Funciones y Procedimientos "
    Private Sub pCargarInformacion()
        ...
        With _obePlantaDeEntrega
            .PNCCLNT = _CodCliente
            .PNCPRVCL = _CodClienteTercero
            .TIPOCLIENTE = _TipoPlantaDeEntrega
            If IsNumeric(txtCodigo.Text.Trim) Then
                .PNCPLNCL = txtCodigo.Text.Trim
            Else
                .PNCPLNCL = 0
            End If
            If txtDescripcion.Text.Trim <> "" Then
                .PSTCMPPL = txtDescripcion.Text.Trim
            Else
                .PSTCMPPL = ""
            End If
        ...
        Me.dtgPlantaDeEntrega.DataSource = odaPlantaDeEntrega.ListarPlantaDeEntrega(_obePlantaDeEntrega)
