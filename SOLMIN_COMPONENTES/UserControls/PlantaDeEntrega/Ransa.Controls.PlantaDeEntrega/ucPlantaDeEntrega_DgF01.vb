...
Public Class ucPlantaDeEntrega_DgF01
...
#Region " Funciones y Procedimientos "
    ...
    '    blnCargando = True
    '    dgCliente.DataSource = oCliente.Listar(oQry_Cliente_L01, sAccesoPorUsuario, intNroTotalPaginas)
    '    blnCargando = False
...
#Region " Métodos "
    ...
    'Public Sub LoadDataSource(ByVal objFiltro As TD_Qry_Cliente_L01, ByVal DataSource As DataTable, ByVal iTPag As Integer)
    '    ' Seteamos los valores que hasta ese momento se ha ingresado 
    '    oQry_Cliente_L01.pCCLNT_Cliente = objFiltro.pCCLNT_Cliente
    '    oQry_Cliente_L01.pTCMPCL_DescripcionCliente = objFiltro.pTCMPCL_DescripcionCliente
    '    oQry_Cliente_L01.pNRUC_NroRUC = objFiltro.pNRUC_NroRUC
