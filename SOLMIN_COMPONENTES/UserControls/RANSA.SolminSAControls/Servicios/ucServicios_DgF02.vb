...
#Region " Atributos "
    ...
    Private TD_ServDispPK As TD_Qry_Servicios_Adquiridos_L02 = New TD_Qry_Servicios_Adquiridos_L02
    Private TD_ServAdquActual As TD_Inf_Servicio_Adquiridos_F01 = New TD_Inf_Servicio_Adquiridos_F01
...
#Region " Funciones y Procedimientos "
    ...
    Private Sub pCargarInformacion()
        ...
        dgServicio.DataSource = daoServicio.fdtListar_Servicios_L02(objSqlManager, oTemp, strMensajeError)
        oTemp = Nothing
    ...
    Private Sub pCargarComboServiciosDisponibles()
        ...
        dtResultado = daoServicio.fdtListar_ServiciosDisponibles_L01(objSqlManager, oTemp, strMensajeError)
        oTemp = Nothing
        If strMensajeError <> "" Then
            RaiseEvent ErrorMessage(strMensajeError)
        Else
