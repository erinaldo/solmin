...
#Region " Atributos "
    ...
    Private TD_Filtro As TD_Qry_Servicio_Mercaderia_F01 = New TD_Qry_Servicio_Mercaderia_F01
    Private TD_MercaderiaActual As TD_Inf_Servicio_Mercaderia_F01 = New TD_Inf_Servicio_Mercaderia_F01
    '-------------------------------------------------
...
#Region " Funciones y Procedimientos "
    ...
    Private Sub pCargarInformacion()
        If TD_Filtro.pCCLNT_CodigoCliente <> 0 Then
            ...
            strMensajeError = ""
            blnCargando = True
            dgMercaderia.DataSource = daoServicio.fdtServicios_Detalle_L03(objSqlManager, oOperacionPK, strMensajeError)
            blnCargando = False
    ...
    Private Sub pMercaderia_Registrar()
        ...
        With oTemp
            ...
            End Select
            If blnOnLine Then
                If Not daoServicio.AgregarDetalleServicio(objSqlManager, oTemp, strUsuario, strMensajeError) Then
                    RaiseEvent ErrorMessage(strMensajeError)
                    txtCodigo.SelectAll()
                    Exit Sub
                End If
    ...
    Private Sub pMercaderia_Cargar(ByVal oTemp As TD_Qry_Servicio_Mercaderia_F01)
        Dim dtTemp As DataTable = daoServicio.fdtServicios_Detalle_L04(objSqlManager, oTemp, strMensajeError)
...
#Region " Eventos "
    ...
    Private Sub btnEliminar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEliminar.Click
        ...
        If blnOnLine Then
            ...
            daoServicio.EliminarDetalleServicio(objSqlManager, oTemp, strUsuario, strMensajeError)
            If strMensajeError <> "" Then
                RaiseEvent ErrorMessage(strMensajeError)
            Else
