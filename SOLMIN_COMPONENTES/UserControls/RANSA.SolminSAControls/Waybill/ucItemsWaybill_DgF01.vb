...
#Region " Atributos "
    ...
    Private TD_Filtro As TD_BultoPK = New TD_BultoPK
    Private TD_ItemBultoActual As TD_Sel_ItemBulto_L01 = New TD_Sel_ItemBulto_L01
...
#Region " Funciones y Procedimientos "
    Private Sub pCargarInformacion()
        If TD_Filtro.pCCLNT_CodigoCliente <> 0 Then
            strMensajeError = ""
            blnCargando = True
            dgItemsBulto.DataSource = daoWayBill.fdtListar_ItemsBultos_L01(objSqlManager, TD_Filtro, strMensajeError)
            blnCargando = False
