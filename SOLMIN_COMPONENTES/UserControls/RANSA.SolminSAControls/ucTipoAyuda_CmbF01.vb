...
Imports RANSA.DATA.slnSOLMIN.DAO.TipoAyuda
...
#Region " Atributos "
    ...
    Private pTipoAyuda As TD_TipoAyuda = New TD_TipoAyuda
...
#Region " Funciones y Procedimientos "
    Private Function pObtenerTipoAyuda(ByVal Codigo As String) As Boolean
        ...
        Dim objTemp As TD_TipoAyuda = daoTipoAyuda.Obtener(objSqlManager, strCategoria, Codigo, strMensajeError)
...
#Region " Eventos "
    Private Sub ucTipoAyuda_CmbF01_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If strCategoria <> "" Then
            Dim dtTemp As DataTable = daoTipoAyuda.fdtListar_TablaAyuda_L01(objSqlManager, strCategoria, strMensajeError)
