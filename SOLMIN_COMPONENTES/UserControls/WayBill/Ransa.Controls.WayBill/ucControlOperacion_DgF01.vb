...
#Region " Atributos "
    ...
    Private oFiltro As TD_Qry_CtrlOperacion = New Ransa.TypeDef.WayBill.TD_Qry_CtrlOperacion
    Private oControlOperacion As TD_ControlOperacion = New Ransa.TypeDef.WayBill.TD_ControlOperacion
...
#Region " Funciones y Procedimientos "
    ...
    Private Sub pCargarInformacion()
        If oFiltro.pSTPODP_TipoAlmacen <> "" And oFiltro.pCTPOAT_TipoOperacion <> "" And oFiltro.pFTRMOP_FechaCierre_Int > 0 Then
            strMensajeError = ""
            blnCargando = True
            dgControlOperaciones.DataSource = cControlOperaciones.fdtListar_ResumenMovimiento_L01(objSqlManager, oFiltro, strMensajeError)
            blnCargando = False
            With oControlOperacion
        ...
        If dgControlOperaciones.RowCount > 0 Then
            ...
            While intCont < dgControlOperaciones.RowCount
                If dgControlOperaciones.Rows(intCont).Cells("M_CHK").Value Then
                    ...
                    End With
                    dgControlOperaciones.Rows(intCont).Cells("M_NOPRSP").Value = cControlOperaciones.Grabar(objSqlManager, oControl, strUsuario, strMensajeError)
                    If strMensajeError <> "" Then
    ...
    Private Sub btnAbrirOperacion_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAbrirOperacion.Click
        ...
        If dgControlOperaciones.RowCount > 0 Then
            If dgControlOperaciones.CurrentRow.Cells("M_NOPRSP").Value > 0 Then
                ...
                End With
                cControlOperaciones.Delete(objSqlManager, oControl, strUsuario, strMensajeError)
                If strMensajeError <> "" Then
                    RaiseEvent ErrorMessage(strMensajeError & vbNewLine & vbNewLine & "Proceso se cancelo...!!!")
                Else
