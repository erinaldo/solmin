Public Class clsTarifarioNeg
    Private oTarifarioDato As clsTarifario
    Private oDt As DataTable

    Sub New()
        oTarifarioDato = New clsTarifario
    End Sub
    ...
    Public Function Busca_Cliente_Grupo(ByVal CodigoGrupo As String) As DataTable
        Return oTarifarioDato.Busca_Cliente_Grupo(CodigoGrupo)
    End Function
