...
Public Class Division_DAL
    ...
    Public Function Lista_Division_X_Usuario(ByVal strCompania As String) As List(Of mantenimientos.ClaseGeneral)
        Dim objDataTable As DataTable
        Dim objLisClaseGeneral As New List(Of mantenimientos.ClaseGeneral)
        Dim objClaseGeneral As mantenimientos.ClaseGeneral
        Dim lobjSql As New SqlManager
        ...
        Try
            ...
            For Each objDataRow As DataRow In objDataTable.Rows
                objClaseGeneral = New mantenimientos.ClaseGeneral
