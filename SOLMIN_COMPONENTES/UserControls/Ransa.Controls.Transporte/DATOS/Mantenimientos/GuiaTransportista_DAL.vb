  ...
  Public Class GuiaTransportista_DAL
    ...
    Public Function Listar_Guias_Anexas_Cliente(ByVal objEntidad As GuiaTransportista) As List(Of GuiaTransportista)
      ...
      Try
        ...
        For Each objData As DataRow In objDataTable.Rows
          ...
          obj_Entidad.TCMPCL = objData("TCMPCL").ToString.Trim
          obj_Entidad.CCLNT = objData("CCLNT")
                    'obj_Entidad.FCGUCL_S = HelpClass.CFecha_de_8_a_10(objData("FCGUCL").ToString.Trim)
    ...
    End Function
        ...
        Public Function Listar_Ordenes_Compra_x_MC(ByVal objEntidad As GuiaOCManifiestoCarga) As List(Of GuiaOCManifiestoCarga)
            Dim objDataTable As New DataTable
            Dim objGenericCollection As New List(Of GuiaOCManifiestoCarga)
            Dim obj_Entidad As GuiaOCManifiestoCarga
            Try
                Dim objParam As New Parameter
                ...
                For Each objData As DataRow In objDataTable.Rows
                    obj_Entidad = New GuiaOCManifiestoCarga
                    obj_Entidad.NGUIRM = objData("NGUIRM")
        ...
        Public Function Listar_Solicitudes_Guia_Transportista(ByVal objetoParametro As Hashtable) As List(Of Operaciones.Detalle_Solicitud_Transporte)
            Dim objDataTable As New DataTable
            Dim objGenericCollection As New List(Of Operaciones.Detalle_Solicitud_Transporte)
            Dim obj_Entidad As Operaciones.Detalle_Solicitud_Transporte
            Try
                Dim objParam As New Parameter
                ...
                For Each objData As DataRow In objDataTable.Rows
                    obj_Entidad = New Operaciones.Detalle_Solicitud_Transporte
                ...
                Next
            Catch ex As Exception
                Return New List(Of Operaciones.Detalle_Solicitud_Transporte)
            End Try
            Return objGenericCollection
        End Function
    ...
    'End Function
        ...
        Public Function Registrar_LiquidacionGuiaTransportista_Reparto(ByVal objEntidad As Operaciones.Repartos, ByVal sErrorMesage As String) As Boolean
            Dim bResultado As Boolean = True
            Try
                Dim objParam As New Parameter
        ...
        Public Function Listar_Consistencia_Liquidacion_x_Orden_Servicio(ByVal objParametro As Hashtable) As List(Of Operaciones.Factura_Transporte)
            ...
            Catch ex As Exception
                objGenericCollection = New List(Of Operaciones.Factura_Transporte)()
            End Try
            Return objGenericCollection
        End Function
        ...
        Public Function Listar_Liquidacion_Flete(ByVal objParametro As Hashtable) As List(Of Operaciones.LiquidacionOperacion)
            Dim objEntidad As Operaciones.LiquidacionOperacion
            Dim objGenericCollection As New List(Of Operaciones.LiquidacionOperacion)
            Dim objParam As New Parameter
            Dim objDataTable As New DataTable
            Try
                ...
                For Each objDataRow As DataRow In objDataTable.Rows
                    objEntidad = New Operaciones.LiquidacionOperacion
            ...
            Catch ex As Exception
                objGenericCollection = New List(Of Operaciones.LiquidacionOperacion)
            End Try
            Return objGenericCollection
        End Function
        ...
        Public Function Listar_Guia_Transportista_Mercaderia(ByVal objetoParametro As Hashtable) As List(Of GuiaTransportista)
            ...
            Try
                ...
                objParam.Add("PNFECFIN", objetoParametro("PNFECFIN"))
                objSql.DefaultSchema = Autenticacion_DAL.GetLibrary(objetoParametro("PSCCMPN"))
                objDataTable = objSql.ExecuteDataTable("SP_SOLMIN_ST_LISTAR_GUIAS_TRANSPORTISTA_MERCADERIA_LA", objParam)
