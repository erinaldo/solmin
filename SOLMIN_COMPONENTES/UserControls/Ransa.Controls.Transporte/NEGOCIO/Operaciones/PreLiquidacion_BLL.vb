...
Namespace Operaciones
  Public Class PreLiquidacion_BLL
    ...
    End Function
        ...
        Public Function Registrar_PreLiquidacion(ByVal objEntidad As Factura_Transporte, ByVal NDCPRF As String, ByVal FDCPRF As String) As Integer
            Try
                ...
                'Next
                Return objDataAccessLayer.Registrar_PreLiquidacion(objEntidad, NDCPRF, FDCPRF)
    ...
    Public Function Anular_Pre_Factura(ByVal objListFactura_Transporte As List(Of Factura_Transporte)) As Integer
      Try
        For Each objEntidad As Factura_Transporte In objListFactura_Transporte
    ...
    Public Function Anular_Pre_Liquidacion(ByVal objListFactura_Transporte As List(Of Factura_Transporte)) As Integer
      Try
        For Each objEntidad As Factura_Transporte In objListFactura_Transporte
