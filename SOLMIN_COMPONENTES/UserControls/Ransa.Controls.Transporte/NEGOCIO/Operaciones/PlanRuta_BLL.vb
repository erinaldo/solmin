...
Public Class PlanRuta_BLL
    Dim objDataAccessLayer As New Operaciones.PlanRuta_DAL

    Public Function Registrar_PlanRutaInicial(ByVal objEntidad As Operaciones.PlanRuta) As Integer
        Return objDataAccessLayer.Registrar_PlanRutaInicial(objEntidad)
    End Function

    Public Function Registrar_PlanRutaViaje(ByVal objEntidad As Operaciones.PlanRuta) As Integer
        Return objDataAccessLayer.Registrar_PlanRutaViaje(objEntidad)
    End Function

    Public Function Listar_PlanRutaInicial(ByVal objEntidad As Operaciones.PlanRuta) As DataTable
    ...
    Public Function Eliminar_PlanRutaViaje(ByVal objEntidad As Operaciones.PlanRuta) As Integer
        Return objDataAccessLayer.Eliminar_PlanRutaViaje(objEntidad)
    End Function

    Public Function Actualiza_PlanRutaInicial(ByVal objEntidad As Operaciones.PlanRuta) As Integer
        Return objDataAccessLayer.Actualiza_PlanRutaInicial(objEntidad)
    End Function

    Public Function Listar_PrioridadCarga(ByVal objEntidad As Operaciones.PlanRuta) As DataTable
        Return objDataAccessLayer.Listar_PrioridadCarga(objEntidad)
    End Function

    Public Function Actualiza_PlanRutaViaje(ByVal objEntidad As Operaciones.PlanRuta) As Integer
        Return objDataAccessLayer.Actualiza_PlanRutaViaje(objEntidad)
    End Function

    Public Function Actualizar_PrioridadCarga(ByVal objEntidad As Operaciones.PlanRuta) As Integer
        Return objDataAccessLayer.Actualizar_PrioridadCarga(objEntidad)
    End Function

    Public Function Elimina_PlanRutaInicial(ByVal objEntidad As Operaciones.PlanRuta) As Integer
    ...
    Public Function Reporte_PlanRutaViaje(ByVal objEntidad As Operaciones.PlanRuta) As DataTable
    ...
    Public Function Listar_PlanRutaViaje(ByVal objEntidad As Operaciones.PlanRuta) As DataTable
        Dim dtTemp As New DataTable
