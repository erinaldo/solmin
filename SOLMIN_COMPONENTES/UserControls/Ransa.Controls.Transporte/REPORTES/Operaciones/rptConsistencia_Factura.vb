...
Public Class rptConsistencia_Factura
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptConsistencia_Factura.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Ransa.Controls.Transporte.rptConsistencia_Factura.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptConsistencia_Factura
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptConsistencia_Factura = New rptConsistencia_Factura
        rpt.Site = Me.Site
        Return rpt
    End Function
