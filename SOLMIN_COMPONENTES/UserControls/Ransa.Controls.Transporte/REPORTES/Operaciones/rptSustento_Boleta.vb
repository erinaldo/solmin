...
Public Class rptSustento_Boleta
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Ransa.Controls.Transporte.rptSustento_Boleta.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSustento_Boleta
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSustento_Boleta = New rptSustento_Boleta
        rpt.Site = Me.Site
        Return rpt
    End Function
