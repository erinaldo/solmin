...
Public Class rptPreLiquidacion
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Ransa.Controls.Transporte.rptPreLiquidacion.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPreLiquidacion
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPreLiquidacion = New rptPreLiquidacion
        rpt.Site = Me.Site
        Return rpt
    End Function
