...
Public Class rptSustento_Factura
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptSustento_Factura.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Ransa.Controls.Transporte.rptSustento_Factura.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSustento_Factura
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSustento_Factura = New rptSustento_Factura
        rpt.Site = Me.Site
        Return rpt
    End Function
