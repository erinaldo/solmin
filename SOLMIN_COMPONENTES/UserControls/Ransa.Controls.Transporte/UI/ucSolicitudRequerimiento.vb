...
Public Class ucSolicitudRequerimiento
    ...
    Private Function Validar() As Boolean
        ...
        If Me.cmbDivision.Division <> "T" Then
            strMensajeError &= "* Seleccionar división Transportes" & vbNewLine
        End If
        ...
        If cmbMercaderia.SelectedValue = 0 Then strMensajeError &= "* Seleccione tipo mercadería" & vbNewLine
        ...
        If txtDireccionOrigen.Text.ToString.Trim = "" Then
            strMensajeError &= "* Ingrese dirección origen" & vbNewLine
        End If

        If txtDireccionDestino.Text.ToString.Trim = "" Then
            strMensajeError &= "* Ingrese dirección destino" & vbNewLine
        End If
            ...
            If dgvDatos.CurrentRow IsNot Nothing Then
                ...
                If Respuesta.Count > 0 Then
                    If Respuesta.Item(0).SESREQ = "A" Or Respuesta.Item(0).SESREQ = "C" Or Respuesta.Item(0).SJTTR = "X" Then
                        MessageBox.Show("No se puede eliminar. El Requerimiento está en Atención, Cerrado y/o en Junta.", "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Information)
                        Exit Sub
                    End If
                End If
                ...
                Case "TabDatosRequerimiento"
                    Select Case gEnumOpc
                        Case EnumMan.Nuevo
                            ...
                            If MessageBox.Show("Se creó el requerimiento:  " & Num_Requerimiento & Environment.NewLine & "¿Desea agregar dimensiones a la mercadería?", "Aviso", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
    ...
    Private Sub Ver_Medidas(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnMedida.Click
        Try
            ...
            If Respuesta.Count > 0 Then
                If Respuesta.Item(0).SESREQ = "A" Or Respuesta.Item(0).SESREQ = "C" Or Respuesta.Item(0).SJTTR = "X" Then
                    MessageBox.Show("No se puede agregar medidas. El Requerimiento está en Atención, Cerrado y/o en Junta.", "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Information)
                    Exit Sub
                End If
            End If
