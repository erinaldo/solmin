...
Public Class frmAsignarPlanRuta
    ...
    Private _ObjServicioMercaderia As ServicioMercaderia
    Private _ObjPlanRuta As Operaciones.PlanRuta
    ...
    Public Property ObjPlanRuta() As Operaciones.PlanRuta
        Get
            Return _ObjPlanRuta
        End Get
        Set(ByVal value As Operaciones.PlanRuta)
            _ObjPlanRuta = value
        End Set
    End Property

    Public Property ObjServicioMercaderia() As ServicioMercaderia
        Get
            Return _ObjServicioMercaderia
        End Get
        Set(ByVal value As ServicioMercaderia)
    ...
    Private Sub ActualizaPlanRuta()
        ...
        If TipoPlanRuta = TIPO_PLAN.INICIAL Then
            Dim ObjPlanRuta_BLL As New PlanRuta_BLL
    ...
    Private Sub frmAsignarPlanRuta_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Me.TipoOperacion = TIPO.MODIFICAR Then
            ...
            Me.dtpFecha.Value = IIf(ObjPlanRuta.PNFECSEG = 0, Date.Today, HelpClass.FechaNum_a_Fecha(ObjPlanRuta.PNFECSEG))
            Me.txtHoraRegistro.Text = String.Format("{0:HH:mm:ss}", HelpClass.CNumero_a_Hora(ObjPlanRuta.PNHRASEG))
