...
#Region " Atributos "
    ...
    '-------------------------------------------------
    Private oInfServicio As mantenimientos.TD_Obj_GRemAgregarServCargadasGTranspLiq = New mantenimientos.TD_Obj_GRemAgregarServCargadasGTranspLiq
    '-------------------------------------------------
...
#End Region
#Region " Propiedades "
    Public ReadOnly Property pInformacionServicio() As mantenimientos.TD_Obj_GRemAgregarServCargadasGTranspLiq
        Get
            Return oInfServicio
        End Get
    End Property
    ...
    Private Sub btnAceptar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Try
            With oInfServicio
                ...
                '.pCSRVC_Servicio = CType(cmbServicio.Resultado, TypeDef.ServTransp.TD_Obj_ServTransp).pCSRVNV_Servicio
                .pCSRVC_Servicio = CType(cmbServicio.Resultado, ServTransp.TD_Obj_ServTransp).pCSRVNV_Servicio
                ...
                '.pCUNDSR_Unidad = CType(cboUnidad.Resultado, TypeDef.Unidad.TD_Inf_Unidad_L02).pCUNDMD_Unidad
                .pCUNDSR_Unidad = CType(cboUnidad.Resultado, Unidad.TD_Inf_Unidad_L02).pCUNDMD_Unidad
                ...
                'sDetalleServicio = CType(cmbServicio.Resultado, TypeDef.ServTransp.TD_Obj_ServTransp).pTCMTRF_Descripcion
                sDetalleServicio = CType(cmbServicio.Resultado, ServTransp.TD_Obj_ServTransp).pTCMTRF_Descripcion
                'Else
...
#End Region
#Region " Métodos "
    Sub New(ByVal Compania As String, ByVal Division As String, ByVal oTemp As mantenimientos.TD_Obj_GRemAgregarServCargadasGTranspLiq)
    ...
    Private Sub frmLiquidacionFlete_DlgLiquServicio_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        With oInfServicio
            ...
            Try
                ...
                'Dim obe As New TypeDef.ServTransp.TD_Obj_ServTransp
                Dim obr As New ServTransp.cServTransp
                Dim obe As New ServTransp.TD_Obj_ServTransp
                cmbServicio.DataSource = Nothing
                cmbServicio.DataSource = HelpClassST.CreateObjectsFromDataTable(Of ServTransp.TD_Obj_ServTransp)(obr.fdtListar(strCompania, strDivision))
                'cmbServicio.DataSource = HelpClassST.CreateObjectsFromDataTable(Of TypeDef.ServTransp.TD_Obj_ServTransp)(obr.fdtListar(strCompania, strDivision))
                ...
                'cboMoneda_2.DataSource = HelpClassST.CreateObjectsFromDataTable(Of TypeDef.Moneda.TD_Moneda)(obr2.fdtListar_Moneda_L01())
                ...
                Dim ref As String = ""
                cboUnidad.DataSource = HelpClassST.CreateObjectsFromDataTable(Of Unidad.TD_Inf_Unidad_L02)(obr3.fdtListar("", "", ref, strCompania))
                Me.cboUnidad.ListColumnas = oListColum
                Me.cboUnidad.Cargas()
                Me.cboUnidad.Limpiar()
                Me.cboUnidad.ValueMember = "pCUNDMD_Unidad"
