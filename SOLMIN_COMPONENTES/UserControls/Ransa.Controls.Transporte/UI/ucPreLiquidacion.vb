...
#Region "Eventos"
    ...
    Private Sub dgwLiquidacion_CellContentClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgwLiquidacion.CellContentClick
        ...
        Try
            ...
            If dgwLiquidacion.Columns(e.ColumnIndex).Name = "btnDetalleLiquidacion" Then
                ...
                Dim ObjFrm As New frmConsultaPreFactura
                If Existe_Ventana(ObjFrm.Name) Then Exit Sub
    ...
    Private Sub btnFacturaPreLiquidacion_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnFacturaPreLiquidacion.Click
        Try
            ...
            Dim obj_LogicaFactura As New Operaciones.Factura_Transporte_BLL
            Me.dgwLiquidacion.EndEdit()
            If Consistencia_Organizacion_Venta(Me.dgwLiquidacion) = False Then
                'HelpClassST.MsgBox("La Organización de Venta de las Pre-Liquidaciones seleccionadas no son las mismas.", MessageBoxIcon.Information)
                MessageBox.Show("La Organización de Venta de las Pre-Liquidaciones seleccionadas no son las mismas.", "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Information)
                Exit Sub
            End If
            Me.dgwLiquidacion.EndEdit()
    ...
    Private Sub btnAnularPreliquidacion_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAnularPreliquidacion.Click
        ...
        Try
            ...
            If lintResultado = 1 Then
                'HelpClassST.MsgBox("Se anuló la Pre - Liquidación Satisfactoriamente")
                MessageBox.Show("Se anuló la Pre - Liquidación Satisfactoriamente", "Aviso", MessageBoxButtons.OK)
                Me.Listar_Liquidacion()
                'Me.Listar_Liquidacion(CType(Me.gwdDatos.SelectedRows(0).Cells("CCLNT").Value, Integer))
            Else
                'HelpClassST.MsgBox("Ocurrió un Error, no se anuló la Pre - Liquidación", MessageBoxIcon.Error)
                MessageBox.Show("Ocurrió un Error, no se anuló la Pre - Liquidación", "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Error)
            End If
    ...
    Private Sub btnImprimir_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnImprimir.Click
        Try
            ...
            Select Case lint_Contador
                ...
                Case Else
                    'HelpClassST.MsgBox("Seleccionar solo una Pre - Liquidación", MessageBoxIcon.Information)
                    MessageBox.Show("Seleccionar solo una Pre - Liquidación", "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Information)
                    Exit Sub
            End Select
    ...
    Private Sub btnValorizar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnValorizar.Click
        ...
        If Obtener_Estado() = True Then
            ...
            Dim objNegocio As New Operaciones.PreLiquidacion_BLL
...
#Region "Métodos"
    ...
    Private Sub Imprimir_PreLiquidacion(ByVal lintNPRLQD As Int64)
        ...
        Dim ListaParametros As New List(Of String)
        Dim oTransporte As New Operaciones.Factura_Transporte
        ...
        Select Case oDtb.Rows(0).Item(0)
            Case 0
                ...
                HelpClassST.CrystalReportTextObject(objetoRep, "lblCompania", Me.cboCompania.Text)
                HelpClassST.CrystalReportTextObject(objetoRep, "lblDivision", Me.cboDivision.Text)
                HelpClassST.CrystalReportTextObject(objetoRep, "lblPlanta", "TODOS")
                'HelpClass.CrystalReportTextObject(objetoRep, "lblPlanta", Me.cboPlanta.Text)
                HelpClassST.CrystalReportTextObject(objetoRep, "lblNroPreliquidacion", "N° " & lintNPRLQD.ToString)
            ...
            Case 1
                ...
                HelpClassST.CrystalReportTextObject(objetoRep_Lote, "lblUsuario", _pUsuario) 'MainModule.USUARIO)
                HelpClassST.CrystalReportTextObject(objetoRep_Lote, "lblCompania", Me.cboCompania.Text)
                HelpClassST.CrystalReportTextObject(objetoRep_Lote, "lblDivision", Me.cboDivision.Text)
                'HelpClass.CrystalReportTextObject(objetoRep_Lote, "lblPlanta", Me.cboPlanta.Text)
                HelpClassST.CrystalReportTextObject(objetoRep_Lote, "lblPlanta", "TODOS")
                HelpClassST.CrystalReportTextObject(objetoRep_Lote, "lblNroPreliquidacion", "N° " & lintNPRLQD.ToString)
    ...
    Private Sub Validar_Acceso_Opciones_Usuario()
        ...
        objParametro.Add("MMCUSR", _pUsuario) 'MainModule.USUARIO)
        objParametro.Add("MMNPVB", _pNameFormulario) 'Me.Name.Trim)
    ...
    Private Function ObtenerTipoCambio() As Double
        ...
        Dim oFacturaNeg As New Operaciones.Factura_Transporte_BLL
    ...
    Private Sub btnFacturacionLibre_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnFacturacionLibre.Click
        Try
            ...
            If Tipo_Cambio > 0 Then
                ...
                End If
            Else
                'HelpClassST.MsgBox("No existe Tipo de Cambio para Hoy", MessageBoxIcon.Information)
                MessageBox.Show("No existe Tipo de Cambio para Hoy", "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Information)
                Exit Sub
            End If
        Catch ex As Exception
        End Try
