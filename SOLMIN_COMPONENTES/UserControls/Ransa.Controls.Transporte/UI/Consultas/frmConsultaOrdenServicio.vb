...
#Region "Eventos"
  ...
  Private Sub frmBuscarOrdenServicio_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.txtCliente.pUsuario = _pUsuario
  ...
  Private Sub btnBuscar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnBuscar.Click
    If Me.txtCliente.pCodigo = 0 Then
            'HelpClassST.MsgBox("Falta elegir el Cliente", MessageBoxIcon.Information)
            MessageBox.Show("Falta elegir el Cliente", "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Information)
      Exit Sub
    End If
  ...
  Private Sub gdwDatos_KeyUp(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles gdwDatos.KeyUp
    If Me.gdwDatos.RowCount = 0 OrElse Me.gdwDatos.CurrentCellAddress.Y = -1 Then Exit Sub
  ...
  Private Sub Seleccionar_Registro(ByVal lint_Registro As Integer)
    For lint_Indice As Integer = 0 To Me.gdwDatos.RowCount - 1
      If lint_Indice = lint_Registro Then
        Me.gdwDatos.Item(0, lint_Registro).Value = My.Resources.button_ok1
      Else
...
#Region "Métodos y Funciones"
  ...
  Private Sub Listar_Orden_Servicio()
        Dim objOrdenServicio As New Operaciones.Factura_Transporte_BLL
