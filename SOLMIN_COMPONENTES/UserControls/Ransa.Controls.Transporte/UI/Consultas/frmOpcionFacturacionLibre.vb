...
#Region "Eventos"
    ...
    Private Sub btnAceptar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAceptar.Click
        ...
        objParametro.Add("PSTRFSRC", txtMotivo.Text.Trim & "-" & _pUsuario) 'MainModule.USUARIO)
        ...
        If obj_Logica.Validar_Facturacion_Libre(objParametro, sMensajeError) Then
            ...
            If obj_Logica.Actualizar_Facturacion_Libre(objParametro) = 0 Then
                'HelpClassST.MsgBox("Las Operaciones se han Facturado con éxito.", MessageBoxIcon.Information)
                MessageBox.Show("Las Operaciones se han Facturado con éxito.", "Aviso", MessageBoxButtons.OK)
