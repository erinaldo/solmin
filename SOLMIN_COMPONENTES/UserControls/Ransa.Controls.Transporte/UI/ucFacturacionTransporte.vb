...
Public Class ucFacturacionTransporte
    ...
    Private Sub btnFactura_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnFactura.Click
        Try
            ...
            If lint_Numerador = 0 Then
                ...
                MessageBox.Show("Ocurrió un error", "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Information)
                Exit Sub
        ...
        Try
            ...
            With frm_ClienteFacturar
                ...
                If obj_Logica.Actualizar_Cliente_Facturar(objetoParametro) = 0 Then
                    'HelpClassST.ErrorMsgBox()
                    MessageBox.Show("Ocurrió un error", "Aviso", MessageBoxButtons.OK)
                    Exit Sub
                End If
                'HelpClassST.MsgBox("Actualización Satisfactoria", MessageBoxIcon.Information)
                MessageBox.Show("Actualización Satisfactoria", "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Information)
...
#Region "Métodos"
    ...
    Private Sub Lista_Operacion_x_OS()
        ...
        Dim obj_Logica As New Operaciones.Factura_Transporte_BLL
        Dim objEntidad As New Operaciones.OperacionTransporte
        ...
        If (Me.chkOS.Checked = True) Then
            ...
            Else
                'HelpClassST.MsgBox("Ingrese la Orden de Servicio ", MessageBoxIcon.Information)
                MessageBox.Show("Ingrese la Orden de Servicio ", "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Information)
                Exit Sub
            End If
        ...
        ElseIf (Me.chkMM.Checked = True) Then
            ...
            Else
                'HelpClassST.MsgBox("Ingrese la Operación Multimodal ", MessageBoxIcon.Information)
                MessageBox.Show("Ingrese la Operación Multimodal ", "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Information)
                Exit Sub
            End If
        Else
            If txtClienteFiltro.pCodigo = 0 Then
                'HelpClassST.MsgBox("Ingrese el Cliente ", MessageBoxIcon.Information)
                MessageBox.Show("Ingrese el Cliente ", "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Information)
                Exit Sub
            Else
    ...
    Private Sub Imprimir_Consistencia(ByVal lstr_Cadena As String)
        ...
        Try
            ...
            objParametro.Add("PNFECHA", HelpClassST.CDate_a_Numero8Digitos(Me.dtpFechaConsistencia.Value))
