...
Public Class frmVisorIncidenciasPorFecha

    Dim rptTemp As rptIncidenciaPorFecha1
    Dim rptTemp_General As New rptIncidenciaPorFecha1
...
#End Region
    ...
    Private Sub BackgroundWorker1_DoWork(ByVal sender As System.Object, ByVal e As System.ComponentModel.DoWorkEventArgs) Handles BackgroundWorker1.DoWork
        ...
        rptTemp = New rptIncidenciaPorFecha1

        _dsReporte.Tables(0).TableName = "Incidencia"
        _dsReporte.Tables(1).TableName = "ResumenIncidencia"

        rptTemp.SetDataSource(_dsReporte.Tables(0).Copy)
        rptTemp.Subreports.Item(0).SetDataSource(_dsReporte.Tables(1).Copy)

        rptTemp.SetParameterValue("pFecha", _FechaInicial)
        rptTemp.SetParameterValue("pFecha1", _FechaFinal)
