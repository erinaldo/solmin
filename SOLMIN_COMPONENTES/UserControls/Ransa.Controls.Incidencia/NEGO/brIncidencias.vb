...
Public Class brIncidencias
    ...
    Public Function Lista_TipoDocRef(ByVal objBE As beIncidencias) As DataTable
        ...
        dt = oDatos.Lista_TipoDocRef(objBE)

        Return dt
    End Function

    Public Function olisListarMovimientoAlmacenSimple(ByVal objBE As beIncidencias) As List(Of beIncidencias)
        Return oDatos.olisListarMovimientoAlmacenSimple(objBE)
    End Function
    ...
    Public Function Lista_Inc_Negocio(ByVal objBE As beIncidencias) As DataTable
        ...
        dt = oDatos.Lista_Inc_Negocio(objBE)
    ...
    Public Function intActualizarMaestroIncidencias_Confirmacion(ByVal obeIncidencias As beIncidencias, ByVal cod_anterior As Integer) As Integer
        Return oDatos.intActualizarMaestroIncidencias_Confirmacion(obeIncidencias, cod_anterior)
    End Function
    ...
    Public Function olistListarMaestroIncidencias(ByVal obeIncidencias As beIncidencias) As DataTable
        Dim dtMeses As DataTable
        Dim dsMeses As New DataSet
        dtMeses = New DataTable
        ...
        dtMeses.Columns.Add("CCMPN", Type.GetType("System.String"))
        dtMeses.Columns.Add("CARINC", Type.GetType("System.String"))
        dtMeses.Columns.Add("CTPINC", Type.GetType("System.Decimal"))
        dtMeses.Columns.Add("TTPINC", Type.GetType("System.String"))
        dtMeses.Columns.Add("TDARINC", Type.GetType("System.String"))
        dtMeses.Columns.Add("CINCID", Type.GetType("System.Int32")) 'TIPO INCIDENCIA
        dtMeses.Columns.Add("TINCSI", Type.GetType("System.String"))
        dtMeses.Columns.Add("STIPPR", Type.GetType("System.String")) 'JDT-Almacén Repuestos On Side - Piura[RF003]-190516
        ...
        Dim ds As New DataSet
        dsMeses = oDatos.olistListarMaestroIncidencias_v2(obeIncidencias)
        ...
        For Fila_M As Integer = 0 To dsMaestInc.Rows.Count - 1
            ...
            drInc("CARINC") = dsMaestInc.Rows(Fila_M)("CARINC")
            drInc("CTPINC") = dsMaestInc.Rows(Fila_M)("CTPINC")
            drInc("TTPINC") = dsMaestInc.Rows(Fila_M)("TTPINC").ToString.Trim
            drInc("TDARINC") = dsMaestInc.Rows(Fila_M)("TDARINC").ToString.Trim
            drInc("CINCID") = dsMaestInc.Rows(Fila_M)("CINCID")
            drInc("TINCSI") = dsMaestInc.Rows(Fila_M)("TINCSI")
            drInc("STIPPR") = dsMaestInc.Rows(Fila_M)("STIPPR") 'JDT-Almacén Repuestos On Side - Piura[RF003]-190516
            CodFila = drInc("CCMPN") & "_" & drInc("CARINC") & "_" & drInc("CINCID")
        ...
        For Fila_Result As Integer = 0 To dtResult.Rows.Count - 1
            ...
            CDVSN = dtResult.Rows(Fila_Result)("CARINC")
    ...
    Public Function olistListarMaestroIncidenciasClientePerfil(ByVal obeIncidencias As beIncidencias) As DataSet
        ...
        Dim dsMeses As New DataSet
        dsMeses = oDatos.olistListarMaestroIncidenciasClientePerfil(obeIncidencias)
        Return dsMeses
    ...
    'Public Function olistListarMaestroIncidenciasCliente(ByVal obeIncidencias As beIncidencias) As DataTable
    ...
    Public Sub InsertarIncidenciasCliente(ByVal obeIncidencias As beIncidencias)
        oDatos.intInsertarIncidenciasCliente(obeIncidencias)
    End Sub

    Public Function intEliminarIncidenciasCliente(ByVal obeIncidencias As beIncidencias) As Integer
        Return oDatos.intEliminarIncidenciasCliente(obeIncidencias)
    End Function

    Public Sub intActualizarRegistroIncidencias(ByVal obeIncidencias As beIncidencias)
        oDatos.intActualizarRegistroIncidencias(obeIncidencias)
    End Sub
    Public Sub intEliminarRegistroIncidencias(ByVal obeIncidencias As beIncidencias)
        oDatos.intEliminarRegistroIncidencias(obeIncidencias)
    End Sub
    ...
    Public Function ConsultaIncidenciaPorMes_V1(ByVal obeIncidencias As beIncidencias, ByVal Lista As List(Of String)) As DataSet
        ...
        Tabla_Anio_Sem = Anio_Semanal(obeIncidencias.ANIO)
        ...
        If dsMeses.Tables(0).Rows.Count > 0 Then
            ...
            For j As Integer = 0 To dsMeses.Tables(0).Rows.Count - 1
                ...
                If Not Visitados.Contains(codigo) Then
                    ...
                    dr = dsMeses_Validado.Tables("MESES").NewRow
                    dr("TCMPCL") = dsMeses.Tables(0).Rows(j).Item("TCMPCL").ToString.Trim
                    dr("TDARINC") = dsMeses.Tables(0).Rows(j).Item("TDARINC").ToString.Trim
