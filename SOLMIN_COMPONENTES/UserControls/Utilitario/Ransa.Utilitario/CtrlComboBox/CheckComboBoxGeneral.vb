...
Namespace CheckComboBoxGeneral
    Public Class CheckedComboBoxGeneral
        Inherits ComboBox
        ''' <summary>
        ...
        Friend Class DD
            ...
            Friend Class CustomCheckedListBox
                ...
                Protected Overloads Overrides Sub OnKeyDown(ByVal e As KeyEventArgs)
                    If e.KeyCode = Keys.Enter Then
                        ' Enact selection.
                        DirectCast(Parent, CheckedComboBoxGeneral.DD).OnDeactivate(New CCBoxEventArgs(Nothing, True))

                        e.Handled = True
                    ElseIf e.KeyCode = Keys.Escape Then
                        ' Cancel selection.
                        DirectCast(Parent, CheckedComboBoxGeneral.DD).OnDeactivate(New CCBoxEventArgs(Nothing, False))
            ...
            Private ccbParent_1 As CheckedComboBoxGeneral
            ...
            Public Sub New(ByVal ccbParent As CheckedComboBoxGeneral)
