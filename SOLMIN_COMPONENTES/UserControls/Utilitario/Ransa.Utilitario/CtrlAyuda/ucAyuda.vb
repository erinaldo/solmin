...
Public Class ucAyuda



    Private _SizeFont As Integer = 0
    Public Property SizeFont() As Integer
        Get
            Return _SizeFont
        End Get
    ...
    Private ofrmAyuda As New frmBusqueda
...
#End Region
    ...
    Private Sub Ayuda()
        ...
        ofrmAyuda.PopupHeight = PopupHeight
        ofrmAyuda.PopupWidth = PopupWidth
        ofrmAyuda.Buscar()
        ofrmAyuda.Etiquetas_Form = _Etiquetas_Form
    ...
    Public Sub Cargas()
        ...
        If SizeFont <> 0 Then
            txtAyuda.StateCommon.Content.Font = New Font(FontFamily.GenericSansSerif, SizeFont)
        End If
    ...
    Public Sub Limpiar()
        ...
        Me.txtAyuda.Tag = ""
        _FiltroData = Nothing
        'RaiseEvent CambioDeTexto(_FiltroData)  'CSR-HUNDRED
    End Sub
End Class
