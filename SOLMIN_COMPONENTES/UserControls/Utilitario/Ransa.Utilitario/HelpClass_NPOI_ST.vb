...
Public Class HelpClass_NPOI_ST
    ...
    'Sub ExportExcelGeneralReleaseMultiple(ListaDatatable As List(Of DataTable), ListTitulo As List(Of String), p3 As Object, LisFiltros As List(Of SortedList), p5 As Integer, p6 As Object)
