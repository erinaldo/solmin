...
#Region " Métodos "
    ...
    Public Function pExportarToXLS(ByVal strFileXLS As String, ByVal iXref As Integer, ByVal iYref As Integer, ByVal dsTemp As DataSet, _
                                Optional ByVal NroLineaGrupoInf As Int32 = 0, Optional ByVal NroLineasBlancas As Int32 = 0, Optional ByVal strTitulo As String = "") As Boolean
        If oAppExcel.ExistApp Then
            oAppExcel.pExportarToXLS(strFileXLS, iXref, iYref, dsTemp, NroLineaGrupoInf, NroLineasBlancas, strTitulo)
        Else
            If oAppOOffice.ExistApp Then
                oAppOOffice.pExportarToXLS(strFileXLS, iXref, iYref, dsTemp, NroLineaGrupoInf, NroLineasBlancas, strTitulo)
            Else
                sErrorMessage = "No existe ningún aplicativo para generar la Hoja de Cálculo."
            End If
        End If
