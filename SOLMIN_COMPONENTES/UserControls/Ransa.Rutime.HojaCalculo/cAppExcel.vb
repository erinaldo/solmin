...
#Region " Métodos "
    ...
    End Sub
    ''' <summary>
    ''' Exporta Excel En Varias Hojas
    ''' </summary>
    ''' <param name="strFileXLS"></param>
    ''' <param name="iXref"></param>
    ''' <param name="iYref"></param>
    ''' <param name="dsTemp"></param>
    ''' <param name="NroLineaGrupoInf"></param>
    ''' <param name="NroLineasBlancas"></param>
    ''' <param name="StrTitul"></param>
    ''' <remarks></remarks>
    Public Sub pExportarToXLS(ByVal strFileXLS As String, ByVal iXref As Integer, ByVal iYref As Integer, ByVal dsTemp As DataSet, _
                              Optional ByVal NroLineaGrupoInf As Int32 = 0, Optional ByVal NroLineasBlancas As Int32 = 0, Optional ByVal StrTitul As String = "")
        Dim oBook As Object = Nothing
        Dim oWorksheet As Object
        sErrorMessage = ""
