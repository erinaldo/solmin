Imports Ransa.NEGO
Public Class frmAdjuntarDocumentos_Bulto
    ...
    Private Sub onSaveCampoNegocioUpload(ByVal sender As Object)
        ...
        Dim objhash As New Hashtable
        objhash.Add("PARAM_CCMPN", Me._PSCCMPN)
        objhash.Add("PARAM_CDVSN", Me._PSCDVSN)
        objhash.Add("PARAM_CPLNDV", Me._PNCPLNDV)
        objhash.Add("PARAM_NMRGIM", CType(sender, String))
        objhash.Add("PARAM_CREFFW", Me._PSCREFFW)
