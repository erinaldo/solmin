...
Public Class rptResumenSegOCProveedor
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptResumenSegOCProveedor.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptResumenSegOCProveedor
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptResumenSegOCProveedor = New rptResumenSegOCProveedor
        rpt.Site = Me.Site
        Return rpt
    End Function
