...
Public Class frmBitacoras
    ...
    Private _beCheckPoint As beCheckPoint
    Public Property beCheckPoint() As beCheckPoint
        Get
    ...
    Private Sub btnGrabar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGrabar.Click
        ...
        Else
            For intX As Integer = 0 To Me.dgvBitacora.Rows.Count - 1
                ...
                End If
                obeCheckPoint.PSCUSCRT = objSeguridadBN.pUsuario
    ...
    Private Sub loadTabla()
        Dim lstResult As List(Of beCheckPoint)
        Dim obrCheckPoint As New brCheckPoint
