...
Public Class rptListadoSloting
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SOLMIN_SA.rptListadoSloting.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptListadoSloting
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptListadoSloting = New rptListadoSloting()
        rpt.Site = Me.Site
        Return rpt
    End Function
