...
Public Class rptRotacionAnual
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SOLMIN_SA.rptRotacionAnual.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRotacionAnual
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRotacionAnual = New rptRotacionAnual()
        rpt.Site = Me.Site
        Return rpt
    End Function
