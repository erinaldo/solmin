...
Public Class StockProductosR01
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SOLMIN_SA.StockProductosR01.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_pIsInventarioActual() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedStockProductosR01
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As StockProductosR01 = New StockProductosR01()
        rpt.Site = Me.Site
        Return rpt
    End Function
