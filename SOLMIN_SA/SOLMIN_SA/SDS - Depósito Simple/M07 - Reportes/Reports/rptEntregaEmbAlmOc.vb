...
Public Class rptEntregaEmbAlmOc
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SOLMIN_SA.rptEntregaEmbAlmOc.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptEntregaEmbAlmOc
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptEntregaEmbAlmOc = New rptEntregaEmbAlmOc()
        rpt.Site = Me.Site
        Return rpt
    End Function
