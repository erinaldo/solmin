...
Public Class frmReporteInventarioPorPosicion
...
#Region "Procedimientos y funciones"
    ...
    Private Sub pReporteInventarioXUbicacionPosicion()
        ...
        Try
            ...
            dView.Sort = "CCLNT, CTPALM, CALMC,CZNALM, CMRCLR, NORDSR,CPSCN DESC"
...
#Region "Eventos de Control"
    ...
    Private Sub bgwGifAnimado_DoWork(ByVal sender As Object, ByVal e As System.ComponentModel.DoWorkEventArgs) Handles bgwGifAnimado.DoWork
        ...
        If Me.rbtubicacion.Checked Then
            pReporteInventarioXUbicacionPosicion()
        Else
            pReporteInventarioMercaderiaPosicion()
        End If
...
#End Region
    ...
    Private Sub Formato01ToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Formato01ToolStripMenuItem.Click
        ...
        Try
            ...
            dtTemp.Columns("TCMZNA").ColumnName = "ZONA \n DESCRIPCIÓN"
