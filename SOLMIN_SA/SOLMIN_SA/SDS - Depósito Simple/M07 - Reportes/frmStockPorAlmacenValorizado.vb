...
Public Class frmStockPorAlmacenValorizado
...
#Region "Eventos de Control"
    ...
    Private Sub tsbExportarExcel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tsbExportarExcel.Click
        ...
        Try
            ...
            DtReporte.TableName = "STOCK-ALMACÉN-VALORIZADO"
            ...
            strlTitulo.Add("Tipo :\n" & IIf(Me.txtTipoAlmacen.Text = "", "TODOS", Me.txtTipoAlmacen.Tag & " - " & Me.txtTipoAlmacen.Text))
            strlTitulo.Add("Almacén :\n" & IIf(Me.txtAlmacen.Text = "", "TODOS", Me.txtAlmacen.Tag & " - " & Me.txtAlmacen.Text))
            strlTitulo.Add("Zona :\n" & IIf(Me.txtZonaAlmacen.Text = "", "TODOS", Me.txtZonaAlmacen.Tag & " - " & Me.txtZonaAlmacen.Text))
