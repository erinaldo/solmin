...
Public Class frmReporteResumenIndicadorAnual

#Region "Declaracion de variables"
    Private objTemp As TipoDato_ResultaReporte
    Private rptTemp = New rptIndicadorAnual
    Private oTemp As New DataTable
...
#Region "Procedimientos y funciones"
    ...
    Private Sub pReporteResumenAnualIndicador()

        rptTemp = New rptIndicadorAnual
        ...
        oTemp = oReporteSDS.frptListar_Resumen_Indicador_Anual(oIndicador, strMensaje)
        ...
        rptTemp.SetDataSource(oTemp)
        CType(rptTemp.ReportDefinition.ReportObjects("txtUsuario"), TextObject).Text = oIndicador.PSCULUSA
...
#Region "Eventos de Control"
    ...
    Private Sub frmReporteResumenIndicadorAnual_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub tsbEnviarCorreo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tsbEnviarCorreo.Click
        Try
            Call mpEnviarEMail(objTemp, "Resumen Indicador Anual", "Informe : Resumen Indicador Anual")
        Catch ex As Exception
