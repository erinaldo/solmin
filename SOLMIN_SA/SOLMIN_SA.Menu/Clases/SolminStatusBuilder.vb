...
Public Class SolminStatusBuilder

    Dim objSqlManager As New SqlManager

    Public Function Listar_Aplicacion_X_Usuario(ByVal IN_MMCAPL As String, ByVal IN_MMCUSR As String) As DataTable
        Dim odt As New DataTable()
        Try
            Dim objParam As New Parameter
            objParam.Add("IN_MMCUSR", IN_MMCUSR)
            objParam.Add("IN_MMCAPL", IN_MMCAPL)
            Return objSqlManager.ExecuteDataTable("SP_SOLMIN_SA_LISTAR_MENU_PRINCIPAL", objParam)
