...
Public Class SolminMenuBuilder
    ...
    Public Function Listar_Menu_Aplicacion_Raiz(ByVal MMCUSR As String, ByVal MMCAPL As String, ByVal MMCMNU As String) As DataTable
        Dim dtbResultados As New DataTable
        Try
            Dim objParam As New Parameter
            objParam.Add("IN_MMCUSR", MMCUSR)
            objParam.Add("IN_MMCAPL", MMCAPL)
            objParam.Add("IN_MMCMNU", MMCMNU)

            dtbResultados = objSqlManager.ExecuteDataTable("SP_SOLMIN_SA_LISTAR_MENU_X_APLICACION", objParam)
        Catch : End Try
        Return dtbResultados
    End Function
