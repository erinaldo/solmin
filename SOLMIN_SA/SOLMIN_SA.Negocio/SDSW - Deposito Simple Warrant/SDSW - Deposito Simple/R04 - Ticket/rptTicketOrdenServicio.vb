...
Public Class rptTicketOrdenServicio
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptTicketOrdenServicio.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RANSA.NEGO.rptTicketOrdenServicio.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_pNumTicket() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptTicketOrdenServicio
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptTicketOrdenServicio = New rptTicketOrdenServicio
        rpt.Site = Me.Site
        Return rpt
    End Function
