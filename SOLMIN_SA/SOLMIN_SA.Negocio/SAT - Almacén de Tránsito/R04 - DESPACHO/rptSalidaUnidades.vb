...
Public Class rptSalidaUnidades
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RANSA.NEGO.rptSalidaUnidades.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSalidaUnidades
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSalidaUnidades = New rptSalidaUnidades()
        rpt.Site = Me.Site
        Return rpt
    End Function
