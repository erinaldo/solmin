...
Public Class rptGuiaRemisionM18
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RANSA.NEGO.rptGuiaRemisionM18.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptGuiaRemisionM18
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptGuiaRemisionM18 = New rptGuiaRemisionM18()
        rpt.Site = Me.Site
        Return rpt
    End Function
