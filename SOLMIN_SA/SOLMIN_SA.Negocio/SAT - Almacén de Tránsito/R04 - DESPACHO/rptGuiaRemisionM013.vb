...
Public Class rptGuiaRemisionM013
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptGuiaRemisionM013.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RANSA.NEGO.rptGuiaRemisionM013.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptGuiaRemisionM013
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptGuiaRemisionM013 = New rptGuiaRemisionM013()
        rpt.Site = Me.Site
        Return rpt
    End Function
