...
Public Class rptGuiaRemisionM09B
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptGuiaRemisionM09B.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RANSA.NEGO.rptGuiaRemisionM09B.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptGuiaRemisionM09B
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptGuiaRemisionM09B = New rptGuiaRemisionM09B()
        rpt.Site = Me.Site
        Return rpt
    End Function
