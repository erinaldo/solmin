...
Public Class rptGuiaRemisionM012
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptGuiaRemisionM012.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RANSA.NEGO.rptGuiaRemisionM012.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptGuiaRemisionM012
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptGuiaRemisionM012 = New rptGuiaRemisionM012()
        rpt.Site = Me.Site
        Return rpt
    End Function
