...
Public Class rptGuiaRemisionM05A
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptGuiaRemisionM05A.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RANSA.NEGO.rptGuiaRemisionM05A.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptGuiaRemisionM05A
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptGuiaRemisionM05A = New rptGuiaRemisionM05A()
        rpt.Site = Me.Site
        Return rpt
    End Function
