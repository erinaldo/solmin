...
Public Class rptIngresosPorLote
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RANSA.NEGO.rptIngresosPorLote.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptIngresosPorLote
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptIngresosPorLote = New rptIngresosPorLote()
        rpt.Site = Me.Site
        Return rpt
    End Function
