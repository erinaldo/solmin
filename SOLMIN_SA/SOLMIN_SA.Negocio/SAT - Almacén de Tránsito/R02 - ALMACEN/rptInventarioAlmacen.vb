...
Public Class rptInventarioAlmacen
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptInventarioAlmacen.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptInventarioAlmacen
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptInventarioAlmacen = New rptInventarioAlmacen
        rpt.Site = Me.Site
        Return rpt
    End Function
