...
Namespace slnSOLMIN_SDS.MantenimientoSDS.Procesos
...
#Region " Métodos "
        ...
        '-------------------------------------------'
        Public Function fdtObtener_Mercaderia(ByVal objPrimaryKey_Mercaderia As clsPrimaryKey_Mercaderia, ByRef strMensajeError As String) As DataTable
            Dim dtResultado As DataTable = Nothing
            dtResultado = fdtResultadoConsulta(strMensajeError, "SDS_MANT_MERCAD_01", objPrimaryKey_Mercaderia.pintCodigoCliente_CCLNT, _
        ...
        '-----------------------------'
        ' FAMILIA
        Public Function fblnGuardar_Familia(ByVal objNuevaFamilia As clsFamilia, ByRef strMensajeError As String) As Boolean
        ...
        Public Function fblnGuardar_Familia(ByVal lstNuevaFamilia As List(Of clsFamilia), ByRef strMensajeError As String) As Boolean
            Dim objFamilia As Familia = Nothing
            Dim objNuevaFamilia As clsFamilia
        ...
        Public Function fblnEliminar_Familia(ByVal objEliminarFamilia As clsFamilia, ByRef strMensajeError As String) As Boolean
            Dim objFamilia As Familia = New Familia
            With objFamilia
        ...
        Public Function fblnEliminar_Familia(ByVal lstFamilia As List(Of clsFamilia), ByRef strMensajeError As String) As Boolean
            Dim objFamilia As Familia = Nothing
            Dim objNuevaFamilia As clsFamilia
            Dim blnResultado As Boolean = True
            Dim strTemp As String = ""
        ...
        ' GRUPO
        Public Function fblnGuardar_Grupo(ByVal objNuevaGrupo As clsGrupo, ByRef strMensajeError As String) As Boolean
        ...
        Public Function fdtGuardar_Grupo(ByVal lstNuevaGrupo As List(Of clsGrupo)) As DataTable
            Dim objNuevaGrupo As clsGrupo
        ...
        Public Function fblnEliminar_Grupo(ByVal objGrupo As clsGrupo, ByRef strMensajeError As String) As Boolean
        ...
        Public Function fdtEliminar_Grupo(ByVal lstGrupo As List(Of clsGrupo)) As DataTable
        ...
        ' MERCADERIA
        Public Function fblnGuardar_Mercaderia(ByRef strMensajeError As String, ByVal objMercaderia As clsMercaderia) As Boolean
            Dim objSqlManager As SqlManager = New SqlManager
            Dim objParametros As Parameter = New Parameter
            Dim intCount As Integer = 0
            objSqlManager.TransactionController(TransactionType.Automatic)
            ...
            With objMercaderia
                ...
                objParametros.Add("IN_FUNCTL", .FUNCTL)
                ...
                objParametros.Add("IN_CPTDAR", .CPTDAR_PartidaArancelaria)
                objParametros.Add("IN_SCNTSR", .SCNTSR_MarcaControlSerie)
                objParametros.Add("IN_USUARIO", strUsuarioSistema)
            End With
            Try
                strMensajeError = ""
                objSqlManager.ExecuteNonQuery("SP_SOLMIN_SA_SDS_MERCADERIA_INS", objParametros)
                Return True
            Catch ex As Exception
        ...
        Public Function fblnGuardar_MercaderiaMasivo(ByVal objMercaderia As clsMercaderia) As String
            ...
            With objMercaderia
                ...
                objParametros.Add("IN_USUARIO", strUsuarioSistema)
            End With
            dt = objSqlManager.ExecuteDataTable("SP_SOLMIN_SA_SDS_MERCADERIA_INS_MASIVO", objParametros)
            Dim msgretorno As String = ""
            For Each item As DataRow In dt.Rows
                If item("STATUS") = "E" Then
                    msgretorno = msgretorno & item("OBSRESULT").ToString.Trim & Chr(10)
                End If
            Next
            Return msgretorno
        End Function

        Public Function fblnEliminar_Mercaderia(ByRef strMensajeError As String, ByVal objPrimaryKey_Mercaderia As clsPrimaryKey_Mercaderia) As Boolean
            Dim objSqlManager As SqlManager = New SqlManager
            Dim objParametros As Parameter = New Parameter
            Dim intCount As Integer = 0
            objSqlManager.TransactionController(TransactionType.Automatic)
        ...
        ' CHOFER
        Public Function fblnGuardar_Chofer(ByVal objNuevoChofer As clsChofer, ByRef strMensajeError As String) As Boolean
            Dim objSqlManager As SqlManager = New SqlManager
            Dim objParametros As Parameter = New Parameter
            Dim intCount As Integer = 0
            objSqlManager.TransactionController(TransactionType.Automatic)
        ...
        Public Function fblnEliminar_Chofer(ByVal objPrimaryKey_Chofer As clsPrimaryKey_Chofer, ByRef strMensajeError As String) As Boolean
            Dim objSqlManager As SqlManager = New SqlManager
            Dim objParametros As Parameter = New Parameter
            Dim intCount As Integer = 0
            objSqlManager.TransactionController(TransactionType.Automatic)
        ...
        ' CAMION
        Public Function fblnGuardar_Camion(ByVal objNuevoCamion As clsCamion, ByRef strMensajeError As String) As Boolean
            Dim objSqlManager As SqlManager = New SqlManager
            Dim objParametros As Parameter = New Parameter
            Dim intCount As Integer = 0
            objSqlManager.TransactionController(TransactionType.Automatic)
        ...
        Public Function fblnEliminar_Camion(ByVal objPrimaryKey_Camion As clsPrimaryKey_Camion, ByRef strMensajeError As String) As Boolean
            Dim objSqlManager As SqlManager = New SqlManager
            Dim objParametros As Parameter = New Parameter
            Dim intCount As Integer = 0
            objSqlManager.TransactionController(TransactionType.Automatic)
        ...
        Public Function Listar_SKU_General(PSCCMPN As String, PNCCLNT As Decimal, PSCMRCLR As String, PNTIPO As Decimal) As DataTable
            ...
            objParametros.Add("PSCMRCLR", PSCMRCLR)
            objParametros.Add("PNTIPO", PNTIPO)
            dt = objSqlManager.ExecuteDataTable("SP_SOLMIN_SA_SDS_LISTAR_SKU_GENERAL", objParametros)
            Return dt
