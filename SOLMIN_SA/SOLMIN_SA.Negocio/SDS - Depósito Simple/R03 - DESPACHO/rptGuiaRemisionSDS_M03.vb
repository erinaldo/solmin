...
Public Class rptGuiaRemisionSDS_M03
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptGuiaRemisionSDS_M03.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RANSA.NEGO.rptGuiaRemisionSDS_M03.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptGuiaRemisionSDS_M03
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptGuiaRemisionSDS_M03 = New rptGuiaRemisionSDS_M03()
        rpt.Site = Me.Site
        Return rpt
    End Function
