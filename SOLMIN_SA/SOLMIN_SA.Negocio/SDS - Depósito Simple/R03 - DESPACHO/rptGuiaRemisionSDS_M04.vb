...
Public Class rptGuiaRemisionSDS_M04
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptGuiaRemisionSDS_M04.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RANSA.NEGO.rptGuiaRemisionSDS_M04.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptGuiaRemisionSDS_M04
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptGuiaRemisionSDS_M04 = New rptGuiaRemisionSDS_M04()
        rpt.Site = Me.Site
        Return rpt
    End Function
