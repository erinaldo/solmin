...
Public Class rptGuiaDespacho2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RANSA.NEGO.rptGuiaDespacho2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptGuiaDespacho2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptGuiaDespacho2 = New rptGuiaDespacho2()
        rpt.Site = Me.Site
        Return rpt
    End Function
