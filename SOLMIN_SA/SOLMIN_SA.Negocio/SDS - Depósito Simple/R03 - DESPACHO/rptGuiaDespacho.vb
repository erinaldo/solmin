...
Public Class rptGuiaDespacho
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RANSA.NEGO.rptGuiaDespacho.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptGuiaDespacho
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptGuiaDespacho = New rptGuiaDespacho()
        rpt.Site = Me.Site
        Return rpt
    End Function
