...
Public Class rptGuiaRemisionSDS_M06
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptGuiaRemisionSDS_M06.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RANSA.NEGO.rptGuiaRemisionSDS_M06.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_p_Guia() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptGuiaRemisionSDS_M06
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptGuiaRemisionSDS_M06 = New rptGuiaRemisionSDS_M06
        rpt.Site = Me.Site
        Return rpt
    End Function
