...
Public Class rptPendienteRecepcion
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptPendienteRecepcion.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RANSA.NEGO.rptPendienteRecepcion.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPendienteRecepcion
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPendienteRecepcion = New rptPendienteRecepcion
        rpt.Site = Me.Site
        Return rpt
    End Function
