...
Public Class rptIndicadorAnual
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RANSA.NEGO.rptIndicadorAnual.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptIndicadorAnual
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptIndicadorAnual = New rptIndicadorAnual
        rpt.Site = Me.Site
        Return rpt
    End Function
