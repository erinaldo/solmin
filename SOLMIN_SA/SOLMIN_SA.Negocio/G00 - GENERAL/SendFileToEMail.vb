...
Namespace SendFileToEMail
    Public Class MAPI
        ...
        Public Function SendMailPopup(ByVal strSubject As String, ByVal strBody As String, ByRef strMensajeError As String) As Integer
            Return SendMail(strSubject, strBody, MAPI_LOGON_UI Or MAPI_DIALOG, strMensajeError)
        End Function

        Public Function SendMailDirect(ByVal strSubject As String, ByVal strBody As String, ByRef strMensajeError As String) As Integer
            Return SendMail(strSubject, strBody, MAPI_LOGON_UI, strMensajeError)
        End Function
        ...
        Private Function SendMail(ByVal strSubject As String, ByVal strBody As String, ByVal how As Integer, ByRef strMensajeError As String) As Integer
            ...
            If m_lastError > 1 Then strMensajeError = "MAPISendMail failed! " + GetLastError()
            Cleanup(msg)
            Return m_lastError
        End Function
