...
Public Class beGeneral
    ...
    Private _PSTDSDES2 As String = ""
    Public Property PSTDSDES2() As String
        Get
            Return _PSTDSDES2
        End Get
        Set(ByVal value As String)
...
#End Region
    ...
    Private _TABCLR As String
    Public Property PSTABCLR() As String
        Get
            Return _TABCLR
        End Get
        Set(ByVal value As String)
    ...
    Private _PSTCMCLR As String
    Public Property PSTCMCLR() As String
        Get
            Return _PSTCMCLR
        End Get
        Set(ByVal value As String)
