Module MainModule
    ...
    Public ReadOnly Property CodVarCompaniaDeploy() As String
        Get
            Return _CodVarCompaniaDeploy
        End Get
    End Property
    Private _CodVarErrorDeploy As String = "IDERROR"
    Public ReadOnly Property CodVarErrorDeploy() As String
        Get
            Return _CodVarErrorDeploy
        End Get
    End Property
    ...
    Public Sub AsignarQueryStringParametersDeploy()
