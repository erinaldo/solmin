...
Public Class ucCalendario
    ...
    Private Sub dgvCalendario_CellDoubleClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgvCalendario.CellDoubleClick
        Try
            ...
            End If
            Dim obeCalendario As New beCalendario
            PNFFRDO = HelpClass.ObjectToInt32(Anio.ToString & ClsCalendarioFeriado.StringRight("0" & Mes, 2) & ClsCalendarioFeriado.StringRight("0" & strDia, 2))
            ...
            strTag = HelpClass.ObjectToString(dgvCalendario.CurrentRow.Cells(e.ColumnIndex).Tag)
            If (strTag <> "") Then
