...
Public Class frmSegEmbarqueResumido
#Region "Atributos"
    ...
    Private ListOperacionRegimen As New List(Of beOperacionRegimen)
    ...
    Private Sub dtgDocAdjuntos_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles dtgDocAdjuntos.DoubleClick
        Try
            ...
            If Me.dtgDocAdjuntos.SelectedCells.Count = 1 Then
                If Me.dtgDocAdjuntos.SelectedCells(0).ColumnIndex = IndexFLGORG Or Me.dtgDocAdjuntos.SelectedCells(0).ColumnIndex = IndexFLGCOP Then
                    If Me.dtgDocAdjuntos.SelectedCells(0).Value.ToString.Trim = "X" Then
                        Me.dtgDocAdjuntos.SelectedCells(0).Value = ""
                        Me.dtgDocAdjuntos.CurrentRow.Cells("NUMDOC").Value = ""
                    Else
                        If Me.dtgDocAdjuntos.CurrentRow.Cells("NUMDOC").Value.ToString.Trim = "" Then
                            Me.dtgDocAdjuntos.SelectedCells(0).Value = "X"
                            Me.dtgDocAdjuntos.CurrentRow.Cells("NUMDOC").Value = "1"
                        End If
                    End If
                End If
...
#End Region
    ...
    'Private Sub btnImportarAgenAscinsa_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnImportarAgenAscinsa.Click
    '    Try
    '        Dim oListRegimen As New List(Of beTipoDato)
    '        Dim msg As String = ""
    '        Dim oListDespacho As New List(Of beTipoDato)
    ...
    '        Dim obrEmbarque As New clsEmbarque
    '        If Me.cmbCliente.pCodigo = 0 Then
    '            msg = "Debe de seleccionar un cliente" & Chr(13)
    '        End If
    '        If oEmbarque.pCMEDTR = 0 Then
    '            msg = msg & "Debe actualizar el medio transporte" & Chr(13)
    '        End If
    '        If oEmbarque.pNORSCI = 0 Then
    '            msg = msg & "Seleccione Embarque" & Chr(13)
    '        End If
    '        If msg.Length > 0 Then
    '            MessageBox.Show(msg, "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Information)
    '            Exit Sub
    ...
    '            oListDespacho = oCloneList.CloneListObject(oListGenTipoDespacho)
    '            frm = New frmImportarAgencia_2(oEmbarque.pCCMPN, oEmbarque.pCDVSN, oEmbarque, oListDespacho, oListRegimen, oEmbarque.pCMEDTR)
    '            frm.pTipoOrigen = frmImportarAgencia_2.TipoOrigen.ASCINSA
    '            If frm.ShowDialog() = Windows.Forms.DialogResult.OK Then
    '                Limpiar_Informacion()
    '                Cargar_Informacion_Embarque()
    '                If oEmbarque.pCCLNT_PORTAL > 0 Then
