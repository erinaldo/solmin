...
Public Class rptMenAdn2010Ini
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SOLMIN_SC.rptMenAdn2010Ini.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptMenAdn2010Ini
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptMenAdn2010Ini = New rptMenAdn2010Ini()
        rpt.Site = Me.Site
        Return rpt
    End Function
