...
Public Class rptRatioLandCost
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SOLMIN_SC.rptRatioLandCost.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRatioLandCost
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRatioLandCost = New rptRatioLandCost()
        rpt.Site = Me.Site
        Return rpt
    End Function
