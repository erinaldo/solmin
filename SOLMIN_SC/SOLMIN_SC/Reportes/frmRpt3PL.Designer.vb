...
Partial Class frmRpt3PL
    ...
    Private Sub InitializeComponent()
        ...
        Me.KryptonLabel4.Text = "Criterio para el Envío de Información : ETA"
        Me.KryptonLabel4.Values.ExtraText = ""
        Me.KryptonLabel4.Values.Image = Nothing
        Me.KryptonLabel4.Values.Text = "Criterio para el Envío de Información : ETA"
        '
        'KryptonLabel3
        '
        ...
        Me.KryptonLabel3.Text = "Mes de Operación:"
        Me.KryptonLabel3.Values.ExtraText = ""
        Me.KryptonLabel3.Values.Image = Nothing
        Me.KryptonLabel3.Values.Text = "Mes de Operación:"
        '
        'pbxEnvio
        '
