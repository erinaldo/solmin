...
Public Class rptLiqAntamina
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SOLMIN_SC.rptLiqAntamina.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptLiqAntamina
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptLiqAntamina = New rptLiqAntamina()
        rpt.Site = Me.Site
        Return rpt
    End Function
