...
Public Class rptMenAdn2010_INGS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SOLMIN_SC.rptMenAdn2010_INGS.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property ReportFooterDetalleDifDias() As CrystalDecisions.CrystalReports.Engine.Section
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Chktiempo() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptMenAdn2010_INGS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptMenAdn2010_INGS = New rptMenAdn2010_INGS()
        rpt.Site = Me.Site
        Return rpt
    End Function
