...
Public Class rptMenAdn2010
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SOLMIN_SC.rptMenAdn2010.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptMenAdn2010
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptMenAdn2010 = New rptMenAdn2010()
        rpt.Site = Me.Site
        Return rpt
    End Function
