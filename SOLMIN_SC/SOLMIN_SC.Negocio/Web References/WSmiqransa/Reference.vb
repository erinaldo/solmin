...
Namespace WSmiqransa
    ...
    Partial Public Class AddData
        ...
        Private SendModelT004OperationCompleted As System.Threading.SendOrPostCallback
        ...
        Public Sub New()
            MyBase.New
            Me.Url = Global.SOLMIN_SC.Negocio.My.MySettings.Default.SOLMIN_SC_Negocio_WSmiqransa_AddData
        ...
        '''<remarks/>
        Public Event SendModelT004Completed As SendModelT004CompletedEventHandler
        ...
        '''<remarks/>
        <System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://www.yrcransaexpediting.com/yrcransaws/AddT004Model", RequestElementName:="AddT004Model", RequestNamespace:="http://www.yrcransaexpediting.com/yrcransaws", ResponseElementName:="AddT004ModelResponse", ResponseNamespace:="http://www.yrcransaexpediting.com/yrcransaws", Use:=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle:=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)>  _
        Public Function SendModelT004(ByVal _DST004 As System.Data.DataSet) As <System.Xml.Serialization.XmlElementAttribute("AddT004ModelResult")> String
            Dim results() As Object = Me.Invoke("SendModelT004", New Object() {_DST004})
            Return CType(results(0),String)
        End Function
        
        '''<remarks/>
        Public Overloads Sub SendModelT004Async(ByVal _DST004 As System.Data.DataSet)
            Me.SendModelT004Async(_DST004, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub SendModelT004Async(ByVal _DST004 As System.Data.DataSet, ByVal userState As Object)
            If (Me.SendModelT004OperationCompleted Is Nothing) Then
                Me.SendModelT004OperationCompleted = AddressOf Me.OnSendModelT004OperationCompleted
            End If
            Me.InvokeAsync("SendModelT004", New Object() {_DST004}, Me.SendModelT004OperationCompleted, userState)
        End Sub
        
        Private Sub OnSendModelT004OperationCompleted(ByVal arg As Object)
            If (Not (Me.SendModelT004CompletedEvent) Is Nothing) Then
                Dim invokeArgs As System.Web.Services.Protocols.InvokeCompletedEventArgs = CType(arg,System.Web.Services.Protocols.InvokeCompletedEventArgs)
                RaiseEvent SendModelT004Completed(Me, New SendModelT004CompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState))
            End If
        End Sub
    ...
    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.7.3062.0")>  _
    Public Delegate Sub SendModelT004CompletedEventHandler(ByVal sender As Object, ByVal e As SendModelT004CompletedEventArgs)
    
    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.7.3062.0"),  _
     System.Diagnostics.DebuggerStepThroughAttribute(),  _
     System.ComponentModel.DesignerCategoryAttribute("code")>  _
    Partial Public Class SendModelT004CompletedEventArgs
        Inherits System.ComponentModel.AsyncCompletedEventArgs
