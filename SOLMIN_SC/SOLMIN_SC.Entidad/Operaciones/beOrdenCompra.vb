...
Public Class beOrdenCompra
    Inherits Base_BE(Of beOrdenCompra)
    Public Sub New()
...
#End Region
    ...
    Private _PNSEGUMIENTO As Integer
    Public Property PNSEGUMIENTO() As Integer
        Get
            Return _PNSEGUMIENTO
        End Get
        Set(ByVal value As Integer)
            _PNSEGUMIENTO = value
        End Set
    ...
    Private _PNEXISTE As Decimal
    Public Property PNEXISTE() As Decimal
        Get
            Return _PNEXISTE
        End Get
        Set(ByVal value As Decimal)
    ...
    Private _PNNRODIAS As Integer
    Public Property PNNRODIAS() As Integer
        Get
            Return _PNNRODIAS
        End Get
        Set(ByVal value As Integer)
