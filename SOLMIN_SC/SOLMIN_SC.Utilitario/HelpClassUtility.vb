...
Public Class HelpClassUtility

    ''' <summary>
    ''' Retorna max dias del mes
    ''' </summary>
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Shared Sub MaxDiasAbrevMes(ByVal Anio As Int32, ByVal Mes As Int32, ByRef MaxDiaMes As Int32, ByRef AbrevMes As String)
        ...
        AbrevMes = Convert.ToDateTime(HelpClassUtility.CNumero8Digitos_a_FechaDefault(Anio.ToString & StringRight("0" & Mes.ToString, 2) & "01")).ToString("MMMM", ci)
    ...
    Public Shared Function Meses(ByVal anio As Int64) As DataTable
        ...
        For index As Integer = 1 To 12
            ...
            Mes = Convert.ToDateTime(HelpClassUtility.CNumero8Digitos_a_FechaDefault(anio.ToString & StringRight("0" & NumMes, 2) & "01")).ToString("MMMM", ci)
