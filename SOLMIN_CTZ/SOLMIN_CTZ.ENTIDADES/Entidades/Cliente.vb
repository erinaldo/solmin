Public Class Cliente
    ...
    Private _DESCP_ESTADO As String = ""
    Private _NROPAG As Decimal = 0
    ...
    Public Property DESCP_ESTADO() As String
        Get
            Return _DESCP_ESTADO
        End Get
        Set(ByVal value As String)
            _DESCP_ESTADO = value
        End Set
    ...
    Public Property NROPAG() As Decimal
        Get
            Return _NROPAG
        End Get
        Set(ByVal value As Decimal)
