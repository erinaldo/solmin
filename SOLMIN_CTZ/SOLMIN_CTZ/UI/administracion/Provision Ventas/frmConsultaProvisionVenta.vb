...
Public Class frmConsultaProvisionVenta
    ...
    Private Sub frmConsultaProvisionVenta_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        oLis.Add("100")
        oLis.Add(HelpClass.CtypeDate(Me.dtpFinal.Value))
    ...
    Private Sub Listar_Operaciones()
        ...
        oServicioOpeBE.FOPRCN_INI = HelpClass.FormatoFechaAS400(Me.dtpInicial.Text)
        oServicioOpeBE.FOPRCN_FIN = HelpClass.FormatoFechaAS400(Me.dtpFinal.Text)
        oServicioOpeBE.CRGVTA = Me.cmbRegionVenta.SelectedValue
        'Llennar Servicio Opreacion
        oDtSerivcio = oServicioOpeBLL.fdtLista_Operaciones_Revisada(oServicioOpeBE)

        oDtServicioDet = oServicioOpeBLL.fdtLista_Operaciones_Revisada(oServicioOpeBE)
    ...
    Private Sub btnExportar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnExportar.Click
        ...
        oServicioOpeBE.FOPRCN_FIN = HelpClass.FormatoFechaAS400(Me.dtpFinal.Text)
        oServicioOpeBE.CRGVTA = Me.cmbRegionVenta.SelectedValue
        oDs = oServicioOpeBLL.fdsLista_Operaciones_Revisada_Exportar(oServicioOpeBE)
        ...
        olstr.Add("Fecha:\n " & Ransa.Utilitario.HelpClass.DateConvert(Me.dtpInicial.Value.ToString) & " Al " & Ransa.Utilitario.HelpClass.DateConvert(Me.dtpFinal.Value.ToString))     'Me.dtFeFinal.Value
        olstr.Add("Tipo de Cambio:\n " & lblTipoCambio_1.Text)

        Dim olstrSuma As New Hashtable
        olstrSuma.Add(1.1, 20)
        olstrSuma.Add(2.1, 7)


        Ransa.Utilitario.HelpClass.ExportExcelConsultaProvicionVenta(oDs, "Consulta de Provisión Venta ", olstr, olstrSuma)
