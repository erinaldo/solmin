...
#Region " Procedimientos y Funciones "
    Private Sub Listar_GRemHijasCargadasGTranspLiq()
        ...
        For Each oEntidad As TD_Obj_GRemHijasCargadasGTranspLiq In oGuiaTransportista.Listar_GRemHijasCargadasGTranspLiquidacion(oFiltro)
    ...
    Private Sub Listar_ServGRemCargadasGTranspLiq()
        ...
        'LLENANDO EL dtGRemCargGTransLiq
        For Each oEntidad As TD_Obj_GRemServCargadasGTranspLiq In oGuiaTransportista.Listar_GRemServCargadasGTranspLiquidacion(oFiltro)
            dwvrow = New DataGridViewRow
...
#Region " Eventos "
    Private Sub btnAgregarServLiqu_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAgregarServLiqu.Click
        ...
        With oInfServ
            ...
            .pMMCUSR_Usuario = ConfigurationWizard.UserName
