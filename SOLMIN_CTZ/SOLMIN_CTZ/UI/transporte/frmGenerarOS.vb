...
Public Class frmGenerarOS
    ...
    Private Sub ActualizarMargen(ByVal dtServicio As DataTable)
        Dim obeOrdenServicio As OrdenServicioTransporte
        ...
        For Each Item As DataRow In dtServicio.Rows
            If Item("MARCA") = "X" Then
                ...
                If Not oHasVisitado.Contains(Cod_Unico) Then
                    ...
                    obeOrdenServicio = New OrdenServicioTransporte
                    ...
                    obeOrdenServicio.CULUSA = ConfigurationWizard.UserName 'MainModule.USUARIO
    ...
    Private Sub CargarCombos()
        ...
        Dim objEntidad As New SOLMIN_CTZ.Entidades.mantenimientos.CentroCosto
    ...
    Private Sub GenerarOS()
        ...
        Try
            ...
            objEntidad.Add("PSCUSCRT", ConfigurationWizard.UserName) 'MainModule.USUARIO)
