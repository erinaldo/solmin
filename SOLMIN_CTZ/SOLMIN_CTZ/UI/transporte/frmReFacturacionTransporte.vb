...
#Region "BACKUP"
'Public Class frmReFacturacionTransporte
...
'                HelpClass.MsgBox("Ingrese el Numero de Factura", MessageBoxIcon.Information)
'                Exit Sub
'            End If
...
'            parametros.Add("PNFECINI", IIf(Me.dtpFechaInicio.Enabled = False, 0, HelpClass_ST.CFecha_a_Numero8Digitos(Me.dtpFechaInicio.Value)))
'            parametros.Add("PNFECFIN", IIf(Me.dtpFechaFin.Enabled = False, 0, HelpClass_ST.CFecha_a_Numero8Digitos(Me.dtpFechaFin.Value)))
...
'                dwvrow.Cells(2).Value = HelpClass_ST.CFecha_de_8_a_10(rowData.Item("FECFAC").ToString.Trim)
...
'            dwvrow.Cells(3).Value = HelpClass_ST.CFecha_de_8_a_10(rowData.Item("FECFAC").ToString)
...
'        Return lstr_Cadena
'    End Function
'    Private Function Consistencia_Operacion_Facturas() As List(Of SOLMIN_CTZ.Entidades.ConsistenciaOperacion)
'        Dim lstr_Operaciones As String = ""
'        Dim lstr_Facturas As String = ""
'        Dim lstr_Fechas As String = ""
'        Dim objConsistenciaOperacion As SOLMIN_CTZ.Entidades.ConsistenciaOperacion
'        Dim lstConsistenciaOperacion As New List(Of SOLMIN_CTZ.Entidades.ConsistenciaOperacion)
...
'            objConsistenciaOperacion = New SOLMIN_CTZ.Entidades.ConsistenciaOperacion
...
'            objConsistenciaOperacion.Fecha = HelpClass_ST.CFecha_10_10(Me.dgwGuiaRemision.Item("FECFAC_D", lint_Contador).Value.ToString.Trim)
...
'                            FechaAtencion = (CType(HelpClass_ST.CFecha_a_Numero8Digitos(.dtpFechaServicio.Value), Int64))
'                        End If
...
'        Dim list As String = ""
'        Dim lista As List(Of SOLMIN_CTZ.Entidades.ConsistenciaOperacion) = Consistencia_Operacion_Facturas()
...
'    Private Sub btnNotaDebito1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNotaDebito1.Click
'        Try
'            Dim objParametro As New Hashtable
'            Dim obj_Logica As New Factura_Transporte_BLL
'            Dim objLogica As New ReFacturacion_BLL
'            Dim objetoParametro As New Hashtable
'            Dim lint_Numerador As Int64 = 0
...
'            Else
'                HelpClass.MsgBox("No se encontro el documento", MessageBoxIcon.Exclamation)
'                Exit Sub
'            End If
...
'    Private Sub btnNotaCredito1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNotaCredito1.Click
'        Try
'            Dim objParametro As New Hashtable
'            Dim obj_Logica As New Factura_Transporte_BLL
'            Dim objLogica As New ReFacturacion_BLL
...
Public Class frmReFacturacionTransporte
    ...
    Private Sub frmReFacturacionTransporte_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
