...
#Region " Atributos "
    ...
    '-------------------------------------------------
    Private oInfServicio As TD_Obj_GRemAgregarServCargadasGTranspLiq = New SOLMIN_CTZ.Entidades.mantenimientos.TD_Obj_GRemAgregarServCargadasGTranspLiq
    '-------------------------------------------------
    ...
    Private Sub btnAceptar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAceptar.Click
        Try
            With oInfServicio
                ...
                .pCSRVC_Servicio = CType(cmbServicio.Resultado, TD_Obj_ServTransp).pCSRVNV_Servicio
                ...
                sDetalleServicio = CType(cmbServicio.Resultado, TD_Obj_ServTransp).pTCMTRF_Descripcion
                'Else
    ...
    Private Sub frmLiquidacionFlete_DlgLiquServicio_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        With oInfServicio
            ...
            Try
                ...
                Dim obe As New TD_Obj_ServTransp
                cmbServicio.DataSource = Nothing
                cmbServicio.DataSource = HelpClass_ST.CreateObjectsFromDataTable(Of TD_Obj_ServTransp)(obr.fdtListar(strCompania, strDivision))
