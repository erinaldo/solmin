...
Imports SOLMIN_CTZ.NEGOCIO.mantenimientos
        ...
        Try
            Select Case _lintEstado
                ...
                Case 2
                    ...
                    Dim oTransporte As New SOLMIN_CTZ.Entidades.Operaciones.Factura_Transporte
        ...
        Try
            ...
            Select Case Me.cboTipoDocumento.SelectedValue
                Case 1
                    ...
                    CType(objetoRepFact.ReportDefinition.ReportObjects("lblUsuario"), TextObject).Text = ConfigurationWizard.UserName
                ...
                Case 7
                    ...
                    CType(objetoRepBole.ReportDefinition.ReportObjects("lblUsuario"), TextObject).Text = ConfigurationWizard.UserName
...
#Region "Eventos Reimpresion de Consistencia por Operacion"
    Private Sub ImprimirConsistencia()
        ...
        Try
            ...
            objParametro.Add("PSCCMPN", _CCMPN)
            objParametro.Add("PSCDVSN", _CDVSN)
            objParametro.Add("PNFECHA", Ransa.Utilitario.HelpClass.CDate_a_Numero8Digitos(_Fecha)) 'Me.dtpFechaConsistencia.Value
    ...
    Private Sub ImprimirPreLiquidacion()
        ...
        Select Case oDtb.Rows(0).Item(0)
            ...
            Case 1
                ...
                HelpClass.CrystalReportTextObject(objetoRep_Lote, "lblUsuario", ConfigurationWizard.UserName)
