...
Public Class frmOpcionCalendario
    ...
    Private Sub btnAceptar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAceptar.Click
        ...
        If (retorno = 1) Then
            MessageBox.Show("La operación se realizó satisfactoriamente.", "Calendario", MessageBoxButtons.OK, MessageBoxIcon.Information)
            myDialogResultOk = True
            Me.Close()
        Else
            'Antes: No se actualizó el dia
            MessageBox.Show("Error de conexión.", "Calendario", MessageBoxButtons.OK, MessageBoxIcon.Information)
        End If
    End Sub
