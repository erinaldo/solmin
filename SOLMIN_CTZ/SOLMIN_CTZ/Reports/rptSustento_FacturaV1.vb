...
Public Class rptSustento_FacturaV1
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptSustento_FacturaV1.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SOLMIN_CT.rptSustento_FacturaV1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSustento_FacturaV1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSustento_FacturaV1 = New rptSustento_FacturaV1()
        rpt.Site = Me.Site
        Return rpt
    End Function
