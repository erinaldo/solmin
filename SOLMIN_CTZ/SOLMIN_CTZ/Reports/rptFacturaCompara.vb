...
Public Class rptFacturaCompara
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SOLMIN_CT.rptFacturaCompara.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptFacturaCompara
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptFacturaCompara = New rptFacturaCompara()
        rpt.Site = Me.Site
        Return rpt
    End Function
