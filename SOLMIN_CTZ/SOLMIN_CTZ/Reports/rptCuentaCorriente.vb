...
Public Class rptCuentaCorriente
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SOLMIN_CT.rptCuentaCorriente.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCuentaCorriente
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCuentaCorriente = New rptCuentaCorriente()
        rpt.Site = Me.Site
        Return rpt
    End Function
