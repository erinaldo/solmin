...
Public Class rptListadoCotizacion
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptListadoCotizacion.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptListadoCotizacion
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptListadoCotizacion = New rptListadoCotizacion
        rpt.Site = Me.Site
        Return rpt
    End Function
