...
Public Class rptFacturaCompara_V2
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptFacturaCompara_V2.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SOLMIN_CT.rptFacturaCompara_V2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptFacturaCompara_V2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptFacturaCompara_V2 = New rptFacturaCompara_V2()
        rpt.Site = Me.Site
        Return rpt
    End Function
