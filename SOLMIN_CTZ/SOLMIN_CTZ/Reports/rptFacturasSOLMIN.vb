...
Public Class rptFacturasSOLMIN
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SOLMIN_CT.rptFacturasSOLMIN.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptFacturasSOLMIN
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptFacturasSOLMIN = New rptFacturasSOLMIN()
        rpt.Site = Me.Site
        Return rpt
    End Function
