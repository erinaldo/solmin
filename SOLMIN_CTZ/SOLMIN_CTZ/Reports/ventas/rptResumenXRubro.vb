...
Public Class rptResumenXRubro
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SOLMIN_CT.rptResumenXRubro.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptResumenXRubro
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptResumenXRubro = New rptResumenXRubro()
        rpt.Site = Me.Site
        Return rpt
    End Function
