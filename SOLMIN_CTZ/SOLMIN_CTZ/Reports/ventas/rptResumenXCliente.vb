...
Public Class rptResumenXCliente
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SOLMIN_CT.rptResumenXCliente.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptResumenXCliente
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptResumenXCliente = New rptResumenXCliente()
        rpt.Site = Me.Site
        Return rpt
    End Function
