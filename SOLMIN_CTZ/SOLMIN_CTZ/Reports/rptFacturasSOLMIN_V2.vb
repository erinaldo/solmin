...
Public Class rptFacturasSOLMIN_V2
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptFacturasSOLMIN_V2.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SOLMIN_CT.rptFacturasSOLMIN_V2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptFacturasSOLMIN_V2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptFacturasSOLMIN_V2 = New rptFacturasSOLMIN_V2()
        rpt.Site = Me.Site
        Return rpt
    End Function
