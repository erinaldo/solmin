...
Public Class rptFacturaSIL
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SOLMIN_CT.rptFacturaSIL.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptFacturaSIL
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptFacturaSIL = New rptFacturaSIL()
        rpt.Site = Me.Site
        Return rpt
    End Function
