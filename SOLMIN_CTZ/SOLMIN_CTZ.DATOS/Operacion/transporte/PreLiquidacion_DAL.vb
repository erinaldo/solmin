...
Namespace Operaciones
  Public Class PreLiquidacion_DAL
    ...
    Public Function Listar_PreLiquidacion(ByVal objParametro As Hashtable) As List(Of OperacionTransporte)
      ...
      Try
        ...
        For Each objDataRow As DataRow In objSql.ExecuteDataTable("SP_SOLMIN_ST_LISTA_PRE_LIQUIDACION", objParam).Rows
    ...
    Public Function Listar_PreFactura(ByVal objParametro As Hashtable) As List(Of Factura_Transporte)
      ...
      Try
        ...
        Dim dt As DataTable = objSql.ExecuteDataTable("SP_SOLMIN_ST_LISTA_PRE_FACTURA", objParam)
        For Each objDataRow As DataRow In dt.Rows
          objEntidad = New Factura_Transporte
          objEntidad.NDCPRF = objDataRow("NDCPRF")
          objEntidad.FDCPRF_S = objDataRow("FDCPRF").ToString.Trim
          objEntidad.IMPOCOS = objDataRow("IMPOCOS")
          objEntidad.IMPOCOD = objDataRow("IMPOCOD")
    ...
    Public Function Listar_Liquidacion(ByVal objParametro As Hashtable) As List(Of Factura_Transporte)
      ...
      Try
        ...
        objSql.DefaultSchema = Autenticacion_DAL.GetLibrary(objParametro("PSCCMPN"))
                Dim oDt As DataTable = objSql.ExecuteDataTable("SP_SOLMIN_ST_LISTA_LIQUIDACION", objParam)
    ...
    Public Function Registrar_PreLiquidacion(ByVal objEntidad As Factura_Transporte) As Integer
      Dim Nro_PreLiquidacion As Integer
      Dim objParam As New Parameter
      Try
        ...
        objSql.ExecuteNonQuery("SP_SOLMIN_ST_REGISTRAR_PRE_LIQUIDACION", objParam)
      ...
      Return objDataSet
        ...
        Public Function Obtener_Reporte_Resumen_X_Lote(ByVal objEntidad As Factura_Transporte) As DataTable
            ...
            Try
                ...
                'Ejecuta el procedimiento almacenado
                objSql.DefaultSchema = Autenticacion_DAL.GetLibrary(objEntidad.CCMPN)
                oDs = objSql.ExecuteDataSet("SP_SOLST_LISTA_MONTOS_X_LOTE", objParam)
