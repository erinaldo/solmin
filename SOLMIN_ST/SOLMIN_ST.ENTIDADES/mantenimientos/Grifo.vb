...
#Region "Atributo"
    ...
    Private _SESTVG As String = ""
        ...
        Private _CPRVGR As Decimal = 0
        Private _DCMPPR As String = ""

        Private _REFCNT As String = ""
        Private _DREGRF As String = ""
        
        Private _NRUCPR As String = ""
...
#Region "Properties"
    ...
    Public Property SESTVG() As String
      ...
      End Set
        ...
        Public Property CPRVGR() As Double
            Get
                Return _CPRVGR
            End Get
            Set(ByVal Value As Double)
        ...
        Public Property DCMPPR() As String
            Get
                Return _DCMPPR
            End Get
            Set(ByVal Value As String)
        ...
        Public Property DREGRF() As String
            Get
                Return _DREGRF
            End Get
            Set(ByVal Value As String)
            ...
            End Set
        End Property
        Public Property REFCNT() As String
            Get
                Return _REFCNT
            End Get
            Set(ByVal Value As String)
        ...
        Public Property NRUCPR() As String
            Get
                Return _NRUCPR
            End Get
            Set(ByVal Value As String)
