...
'Esto es un comentario solo para GIT
	Public x_var_remote_git As String ="remote_only"
	Public x_var_origin_git As String ="push_remote_only"
    Public x_var_system_deploy = "remote"
  ...
  Public gintEstadoDocOperacion As Int16 = 0
    ...
    Public Function FormatoHora(ByVal texto As String) As String
        If texto = "" Then
            texto = "0000"
        End If
  ...
  Public Sub CargarTablasGlobales()
    ...
    MainModule.gobj_TablasGeneralesdelSistema.Add("PLANTA", objDbBridge.GetTable("CALL SP_SOLMIN_TR_LISTAR_PLANTAS('" & HelpClass.getSetting("Compania") & "','" & HelpClass.getSetting("Division") & "')"))
