...
Public Class frmTractoAcoplado_Mant
    ...
    Private Sub frmTractoAcoplado_Mant_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            'Cargar_Compania()
            Cargar_Tipo()
            ...
            txtRUC.Text = _NRUCTR
            txtPlacaUnidad.Text = _NPLCAC
            txtRazonSocial.Text = _pRazonSocial

            If _STPACP.ToString.Trim = "" Then
                cboTipo.SelectedValue = "0"
            Else
                cboTipo.SelectedValue = _STPACP
            End If
    ...
    Private Sub btnGuardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGuardar.Click
        Try
            ...
            Entidad.NPLCAC = txtPlacaUnidad.Text
            ...
            Entidad.STPACP = cboTipo.SelectedValue
            ...
            If objAcoplado.Modificar_Asignacion_Acoplado_Transportista(Entidad) = 1 Then
