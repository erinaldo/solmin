...
#Region "Eventos"
  ...
  Private Sub Listar_Operaciones_Facturadas()
    ...
    Try
      ...
      parametros.Add("PNFECINI", IIf(Me.dtpFechaInicio.Enabled = False, 0, HelpClass.CFecha_a_Numero8Digitos(Me.dtpFechaInicio.Value)))
      parametros.Add("PNFECFIN", IIf(Me.dtpFechaFin.Enabled = False, 0, HelpClass.CFecha_a_Numero8Digitos(Me.dtpFechaFin.Value)))
      ...
      Me.dgwGuiaRemision.Rows.Clear()
            ...
            For Each rowData In ReFacturaDAL.Listar_Operaciones_Liquidadas(parametros).Rows
                ...
                dwvrow.Cells(2).Value = HelpClass.CFecha_de_8_a_10(rowData.Item("FECFAC").ToString.Trim)
    ...
    Private Sub Lista_GR_x_Operacion(ByVal Indice As Integer)
        ...
        For Each rowData In ReFacturaDAL.Listar_Guias_X_Operaciones(parametros).Rows
            ...
            dwvrow.Cells(3).Value = HelpClass.CFecha_de_8_a_10(rowData.Item("FECFAC").ToString)
...
#End Region
  ...
  Private Function Consistencia_Operacion() As String
    ...
    Return lstr_Cadena
  End Function
    Private Function Consistencia_Operacion_Facturas() As List(Of ENTIDADES.ConsistenciaOperacion)
        Dim lstr_Operaciones As String = ""
        Dim lstr_Facturas As String = ""
        Dim lstr_Fechas As String = ""
        Dim objConsistenciaOperacion As ENTIDADES.ConsistenciaOperacion
        Dim lstConsistenciaOperacion As New List(Of ENTIDADES.ConsistenciaOperacion)
        ...
        For lint_Contador As Integer = 0 To Me.dgwGuiaRemision.RowCount - 1
            objConsistenciaOperacion = New ENTIDADES.ConsistenciaOperacion
            ...
            objConsistenciaOperacion.Fecha = HelpClass.CFecha_10_10(Me.dgwGuiaRemision.Item("FECFAC_D", lint_Contador).Value.ToString.Trim)
  ...
  End Function
    Private Function ListOperaciones() As String
        ...
        Dim list As String = ""
        Dim lista As List(Of ENTIDADES.ConsistenciaOperacion) = Consistencia_Operacion_Facturas()
