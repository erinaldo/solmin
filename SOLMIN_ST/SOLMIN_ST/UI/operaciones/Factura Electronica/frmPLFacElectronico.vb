        ...
        Try
            ...
            For intIndice As Integer = 0 To dgwLiquidacion.RowCount - 1
                If dgwLiquidacion.Item("chk2", intIndice).Value = True Then
                    ...
                    If EstadoPL = "B" Then
                        MessageBox.Show("PL Bloqueado para facturación", "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Warning)
                        Exit Sub
                    End If
    ...
    Private Sub btnFacturaPreDoc_Click(sender As Object, e As EventArgs) Handles btnFacturaPreDoc.Click
        Try
            ...
            If CodEstadoPL = "B" Then
                MessageBox.Show("No se puede facturar una liquidación en Pre-Documento ", "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Warning)
                Exit Sub
            End If
