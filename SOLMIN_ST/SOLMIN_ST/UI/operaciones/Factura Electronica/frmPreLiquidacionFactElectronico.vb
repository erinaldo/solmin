...
Public Class frmPreLiquidacionFactElectronico
...
#Region "Eventos"
    ...
    Private Sub frmPreLiquidacion_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            gwdDatos.Columns("NROVLR").Visible = False
            gwdDatos.Columns("DOCVLR").Visible = False
            gwdDatos.Columns("SEGVLR_DESC").Visible = False
        ...
        Try
            ...
            If dgwLiquidacion.Columns(e.ColumnIndex).Name = "btnDetalleLiquidacion" Then
                ...
                With objfrmConsultaPreFactura
                    ...
                    .pCCLNT = Me.gwdDatos.Item("CCLNT", Me.gwdDatos.CurrentCellAddress.Y).Value
                    .pCCLNFC = Me.gwdDatos.Item("CCLNT", Me.gwdDatos.CurrentCellAddress.Y).Value
                    .ShowDialog()
                    Me.Listar_Liquidacion()
                End With
    ...
    Private Sub btnFacturaPreLiquidacion_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnFacturaPreLiquidacion.Click
        Try
            ...
            With frm_OpcionFactura
                ...
                frm_OpcionFactura.lblOperacion.Text = "N° Liquidación"
                ...
                Select Case tipoClienteDocumento
                    Case TipoCliente.Externo
                        ...
                        Dim objfrmVistaFactura As New frmVistaFacturaElectronico(Cadena.TrimEnd(","), cboDivision.Text, Me.cboDivision.SelectedValue, Me.cboCompania.SelectedValue, Me.gwdDatos.Item("CCLNT", lint_Contador).Value, frm_OpcionFactura.Planta, IIf(frm_OpcionFactura.rbtnDolares.Checked, "DOL", "SOL"), strZonaFacturacion, cOrgVenta, ValorizacionOK)
                    ...
                    Case TipoCliente.Interno
                        ...
                        Dim objfrmVistaPT As New frmVistaParteTransferencia(Cadena.TrimEnd(","), cboDivision.Text, Me.cboDivision.SelectedValue, Me.cboCompania.SelectedValue, Me.gwdDatos.Item("CCLNT", lint_Contador).Value, frm_OpcionFactura.Planta, IIf(frm_OpcionFactura.rbtnDolares.Checked, "DOL", "SOL"), strZonaFacturacion, cOrgVenta, Trim(Aprobador))
                        'CSR-HUNDRED-SGR-DEF-SALMON-ST-FASE2-VENTA-INTERNA-PT-FIN 
                        Select Case frm_OpcionFactura.Tag
                            Case 0
...
#Region "Métodos"
    ...
    Private Sub Listar_PreLiquidacion()
        ...
        '    objetoParametro.Add("PSTIPOVISTA", "VLR")
        'Else
        ...
        gwdDatos.DataSource = obj_Logica.Listar_PreLiquidacion_Factura(objetoParametro)
    ...
    Private Sub Listar_Liquidacion()
        ...
        objetoParametro.Add("PNNROVLR", gwdDatos.Item("NROVLR", gwdDatos.CurrentCellAddress.Y).Value)
        objetoParametro.Add("PSTIPOVISTA", gwdDatos.Item("POR_VLR", gwdDatos.CurrentCellAddress.Y).Value)

        'If gwdDatos.Item("POR_VLR", gwdDatos.CurrentCellAddress.Y).Value = "S" Then
        '    objetoParametro.Add("PNNROVLR", gwdDatos.Item("NROVLR", gwdDatos.CurrentCellAddress.Y).Value)
        '    objetoParametro.Add("PSTIPOVISTA", "VLR")
        'Else
...
#End Region
    ...
    'Private Sub chkValorizacion_Click(sender As Object, e As EventArgs)
    '    Try
    '        gwdDatos.DataSource = Nothing
    '        dgwLiquidacion.DataSource = Nothing

    '        gwdDatos.Columns("NROVLR").Visible = chkValorizacion.Checked
    '        gwdDatos.Columns("DOCVLR").Visible = chkValorizacion.Checked
    '        gwdDatos.Columns("SEGVLR_DESC").Visible = chkValorizacion.Checked
