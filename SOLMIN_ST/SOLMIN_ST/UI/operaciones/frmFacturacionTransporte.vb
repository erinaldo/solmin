...
#Region "Atributos"
    ...
    Private codigoSector As String = "" 'ECM-HUNDRED
#End Region
            ...
            Else 'If lint_Numerador = -1 Then
                ...
                With frm_OpcionFactura
                    ...
                    Else
                        ...
                        frm_VistaFactura = New frmVistaFactura(lstr_Consistencia, Me.cboDivision.Text, Me.cboDivision.SelectedValue, Me.cboCompania.SelectedValue, CType(Me.Consistencia_Cliente, Int64), PlantaSeleccionada, IIf(frm_OpcionFactura.rbtnDolares.Checked, "DOL", "SOL"), strZonaFacturacion, cOrgVenta)
...
#Region "Métodos"
    ...
    Private Sub Lista_Operacion_x_OS()
        ...
        For Each objEntidad In obj_Logica.Listar_Operacion_x_Orden_Servicio(objetoParametro)
            ...
            'ECM-HUNDRED-INICIO
            dwvrow.Cells(16).Value = objEntidad.CDSCSP
            dwvrow.Cells(17).Value = objEntidad.CDSCSP_TDSCSP
            'ECM-HUNDRED-FIN
            dwvrow.Cells(18).Value = objEntidad.SESTOP
            dwvrow.Cells(19).Value = objEntidad.TDRCNS
            dwvrow.Cells(20).Value = objEntidad.NRUCCN
            dwvrow.Cells(21).Value = IIf(objEntidad.SORGMV.Equals(""), "NO", "SI")
            dwvrow.Cells(22).Value = objEntidad.CRGVTA
            dwvrow.Cells(23).Value = objEntidad.CPLNDV
    ...
    Private Function Consistencia_Operacion() As String
        ...
        For lint_Contador As Integer = 0 To Me.gwdDatos.RowCount - 1
            If Me.gwdDatos.Item(0, lint_Contador).Value Then
                ...
                codigoSector = gwdDatos.Item("CDSCSP", lint_Contador).Value.ToString()
            End If
        Next
