...
Public Class frmVistaFactura
  ...
  Public WriteOnly Property FlagFactura() As Int32
    ...
    Sub New(ByVal pstrConsistencia As String, ByVal pstrDivision As String, ByVal pstrCodDiv As String, ByVal pstrCodCom As String, ByVal pdblCliente As Double, ByVal pstrCodPlanta As String, ByVal pstrMoneda As String, ByVal pintZonaFacturacion As Int32, ByVal pstrOrgVenta As String)
        ' Llamada necesaria para el Diseñador de Windows Forms.
        InitializeComponent()
  ...
  End Sub
    ...
    Private Sub btnGenerar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGenerar.Click
        ...
        'objHash1.Add("CRGVTA", strOrgVenta.Trim.PadLeft(3, "0"))
        ...
        If validado = True Then
            ...
            Select Case oFacturaNeg.Validar_Cliente_Electronico_AS(objHash1)
                Case "1"
                    Me.btnImprimirfactura.Enabled = ComponentFactory.Krypton.Toolkit.ButtonEnabled.False
                    MessageBox.Show("Cliente habilitado para electrónico.", "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Warning)
            End Select
        ...
        For lint_Contador As Integer = 0 To intCant - 1
            ...
            Select Case Me.Tag
                Case 0
                    ...
                    oHasResumenVista.Add(lint_Contador + 1, octrlFact)
  ...
  End Sub
    ...
    Private Sub Grabar_Factura(ByVal pintFact As Integer)
        ...
        'Dim GuardarVistaImpresion As Boolean = True
        ...
        Try
            ...
            oFacturaNeg.Grabar_Factura(pintFact, oDtCabFactura, oDtDetFactura, strNumFact, lstrIGV, dtVistaFact, Me.Tag, True, intFlagFact)
    ...
    '        oFacturaNeg.Grabar_Factura_Lote(pintFact, oDtCabFactura, oDtDetFactura, strNumFact, lstrIGV, dtVistaFact, Me.Tag, True, intFlagFact)
  ...
  End Sub
    ...
    Private Sub PrintPageHandler(ByVal sender As Object, ByVal args As Printing.PrintPageEventArgs)
                    ...
                    If oDs.Tables(1).Rows(intCont).Item("CRBCTC").ToString.Trim <> "999" Then
                        ...
                        If strMoneda_Local = "USD" Then
                            ...
                            If oFacturaNeg.oTipoDocumento = 7 Then
                                dblIGV = 1 + System.Math.Round(CType(lstrIGV, Double) / 100, 2) 'CType(lstrIGV, Double) / 100
        ...
        If bolIGV Then
            ...
            If oFacturaNeg.oTipoDocumento = 1 Then
                If strMoneda_Local = "USD" Then
                    ...
                    dblTotal = dblTotal + (dblTotal * System.Math.Round((CType(lstrIGV, Double) / 100), 2)) 'oDs.Tables(1).Rows(oDs.Tables(1).Rows.Count - 1).Item("IVLDCD")
                Else
                    ...
                    dblTotal = dblTotal + (dblTotal * System.Math.Round((CType(lstrIGV, Double) / 100), 2)) 'oDs.Tables(1).Rows(oDs.Tables(1).Rows.Count - 1).Item("IVLDCS")
                End If
            End If
            intPosLinea = intPosLinea + 13
        End If
        dblSubTotalSoles = dblSubTotalSoles + (dblSubTotalSoles * System.Math.Round((CType(lstrIGV, Double) / 100), 2))
        ...
        If oFacturaNeg.oTipoDocumento = 1 Then
            ...
            If (dblSubTotalSoles) >= pnMonto And pnPorcentaje > 0 Then
                args.Graphics.DrawString("OP. SUJETA AL S.P.O.T. CON EL GOB.CENTRAL POR EL  " & oDs.Tables(0).Rows(0).Item("NDSPGD") & " % " & " -  CUENTA " & IIf(strCodCom.Trim.Equals("EZ"), "362956", "").ToString, New Font(myFont, FontStyle.Regular), Brushes.Black, 140, 743)
            End If
