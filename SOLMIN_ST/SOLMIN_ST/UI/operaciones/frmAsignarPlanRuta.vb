...
Public Class frmAsignarPlanRuta
    ...
    Private _ObjServicioMercaderia As ENTIDADES.ServicioMercaderia
    ...
    Public Property ObjServicioMercaderia() As ENTIDADES.ServicioMercaderia
        Get
            Return _ObjServicioMercaderia
        End Get
        Set(ByVal value As ENTIDADES.ServicioMercaderia)
    ...
    Private Sub ObtieneInformacion(ByVal objTemp As PlanRuta)
        ...
        objTemp.PSUSRCRT = MainModule.USUARIO
        objTemp.PSNTRMCR = Ransa.Utilitario.HelpClass.NombreMaquina
    End Sub
    ...
    Private Sub frmAsignarPlanRuta_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim objLocalidad As New NEGOCIO.Localidad_BLL
