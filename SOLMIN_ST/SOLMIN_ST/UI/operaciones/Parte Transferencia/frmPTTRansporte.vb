...
#Region "Eventos"
    Private Sub frmPTTRansporte_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            Else 'If lint_Numerador = -1 Then
                ...
                With frm_OpcionFactura
                    ...
                    Else
                        ...
                        Dim frm_VistaFactura As frmVistaParteTransferencia
