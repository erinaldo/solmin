...
Public Class frmPTPreLiqTRansporte
    ...
    Private Sub btnFacturaPreLiquidacion_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnFacturaPreLiquidacion.Click
        Try
            ...
            With frm_OpcionFactura
                ...
                End If
                'Dim objfrmVistaFactura As New frmVistaParteTransferencia(Cadena.TrimEnd(","), cboDivision.Text, Me.cboDivision.SelectedValue, Me.cboCompania.SelectedValue, Me.gwdDatos.Item("CCLNT", lint_Contador).Value, decPlanta, IIf(frm_OpcionFactura.rbtnDolares.Checked, "DOL", "SOL"), strZonaFacturacion, cOrgVenta, FechaFactura, FechaAtencion)
                'With objfrmVistaFactura
                '    '.pEstado = 1
                '    .Tag = frm_OpcionFactura.Tag
                '    .NumDocOrigen = dblDocumentoOrigen
                '    .FechaDocOrigen = dblFechaDocumentoOrigen
                '    .TipoDocOrigen = dblTipoDocumentoOrigen
                Dim objfrmVistaFactura As New frmVistaParteTransferencia(Cadena.TrimEnd(","), cboDivision.Text, Me.cboDivision.SelectedValue, Me.cboCompania.SelectedValue, Me.gwdDatos.Item("CCLNT", lint_Contador).Value, decPlanta, IIf(frm_OpcionFactura.rbtnDolares.Checked, "DOL", "SOL"), strZonaFacturacion, cOrgVenta, FechaFactura, FechaAtencion)
                With objfrmVistaFactura
                    '.pEstado = 1
                    .EsXPreLiquidacion = True
                    '.Tag = frm_OpcionFactura.Tag
                    Select Case frm_OpcionFactura.Tag
                        Case 0
                            .TipoVistaImpresion = clsComun.VistaImpresion.Normal
                        Case 1
                            .TipoVistaImpresion = clsComun.VistaImpresion.Resumido
                        Case 2
                            .TipoVistaImpresion = clsComun.VistaImpresion.Detallado
                        Case 3
                            .TipoVistaImpresion = clsComun.VistaImpresion.Lote
                    End Select
                    .NumDocOrigen = dblDocumentoOrigen
                    .FechaDocOrigen = dblFechaDocumentoOrigen
                    .TipoDocOrigen = dblTipoDocumentoOrigen
