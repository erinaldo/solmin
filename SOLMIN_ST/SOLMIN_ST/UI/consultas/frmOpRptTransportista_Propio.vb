...
Public Class frmOpRptTransportista_Propio
    ...
    Public Sub imprimir()
        ...
        Dim objRepT As New rptTransportista_Tracto
        ...
        Try
            ...
            If Me.chkVehiculos.Checked Then
                ...
                'Dim dtbVehiculos As DataTable = HelpClass.GetDataSetNative(objRepVehiculo.Listar_TractosPorTransportista(objVehiculo))
                Dim dtbVehiculos As DataTable = objRepVehiculo.Listar_TractosPorTransportista_Propio(objVehiculo)
                If dtbVehiculos.Rows.Count > 0 Then
                    objRepT.OpenSubreport("rptTransportistaVehiculo_Propio.rpt").SetDataSource(dtbVehiculos)
                    objRepT.Refresh()
                End If
            End If
            ...
            If Me.chkAcoplados.Checked Then
                ...
                Dim dtbAcoplados As DataTable = objRepAcoplado.Listar_AcopladosPorTransportista_Reporte_Propio(objAcoplado)
                If dtbAcoplados.Rows.Count > 0 Then
                    objRepT.OpenSubreport("rptTransportistaAcoplado_Tracto.rpt").SetDataSource(dtbAcoplados)
                    objRepT.Refresh()
                End If
            End If
            ...
            objRepT.SetParameterValue("pMostrarSubRepVehiculo1", lstr_MostrarSubRptVehiculo)
            objRepT.SetParameterValue("pMostrarSubRptAcoplado1", lstr_MostrarSubRptAcoplado)
            objRepT.SetParameterValue("pMostrarSubRptConductor1", lstr_MostrarSubRptConductor)
