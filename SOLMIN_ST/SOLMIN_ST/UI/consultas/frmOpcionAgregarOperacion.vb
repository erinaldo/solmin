...
Public Class frmOpcionAgregarOperacion
...
#Region "Eventos"
  ...
  Private Sub btnAceptar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAceptar.Click
    Try
      If Me.rbtnGuiaTransporte.Checked = True Then
        Me._OPCION = 1
      Else
        ...
        Else
          Dim obj_Logica As New OperacionTransporte_BLL
                    Dim ldob_NPLNMT As Double = obj_Logica.Validar_Existe_Operacion(Me.txtOperacion.Text, "")
  ...
  Private Sub rbtnOperacion_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles rbtnOperacion.CheckedChanged
    If Me.rbtnGuiaTransporte.Checked = False Then
  ...
  Private Sub txtOperacion_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtOperacion.KeyUp
    If Me.txtOperacion.Text.Trim("") Then Exit Sub
