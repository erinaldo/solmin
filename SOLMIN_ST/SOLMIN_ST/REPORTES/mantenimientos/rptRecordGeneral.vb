...
Public Class rptRecordGeneral
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SOLMIN_ST.rptRecordGeneral.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRecordGeneral
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRecordGeneral = New rptRecordGeneral()
        rpt.Site = Me.Site
        Return rpt
    End Function
