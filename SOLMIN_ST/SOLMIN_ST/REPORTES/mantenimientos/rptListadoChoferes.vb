...
Public Class rptListadoChoferes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SOLMIN_ST.rptListadoChoferes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptListadoChoferes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptListadoChoferes = New rptListadoChoferes()
        rpt.Site = Me.Site
        Return rpt
    End Function
