...
Public Class rptListadoTractos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SOLMIN_ST.rptListadoTractos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptListadoTractos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptListadoTractos = New rptListadoTractos()
        rpt.Site = Me.Site
        Return rpt
    End Function
