...
Public Class rptReporteSeguro
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SOLMIN_ST.rptReporteSeguro.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptReporteSeguro
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptReporteSeguro = New rptReporteSeguro()
        rpt.Site = Me.Site
        Return rpt
    End Function
