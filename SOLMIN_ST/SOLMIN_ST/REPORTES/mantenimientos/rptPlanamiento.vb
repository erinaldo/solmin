...
Public Class rptPlanamiento
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SOLMIN_ST.rptPlanamiento.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPlanamiento
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPlanamiento = New rptPlanamiento()
        rpt.Site = Me.Site
        Return rpt
    End Function
