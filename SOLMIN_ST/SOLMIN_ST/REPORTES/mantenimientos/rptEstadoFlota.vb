...
Public Class rptEstadoFlota
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SOLMIN_ST.rptEstadoFlota.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptEstadoFlota
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptEstadoFlota = New rptEstadoFlota()
        rpt.Site = Me.Site
        Return rpt
    End Function
