...
Public Class rptTarifaGrifo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SOLMIN_ST.rptTarifaGrifo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptTarifaGrifo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptTarifaGrifo = New rptTarifaGrifo()
        rpt.Site = Me.Site
        Return rpt
    End Function
