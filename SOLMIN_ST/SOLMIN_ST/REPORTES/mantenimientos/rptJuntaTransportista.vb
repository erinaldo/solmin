...
Public Class rptJuntaTransportista
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptJuntaTransportista.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SOLMIN_ST.rptJuntaTransportista.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptJuntaTransportista
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptJuntaTransportista = New rptJuntaTransportista()
        rpt.Site = Me.Site
        Return rpt
    End Function
