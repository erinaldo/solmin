...
Public Class rptRecordMedico
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SOLMIN_ST.rptRecordMedico.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRecordMedico
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRecordMedico = New rptRecordMedico()
        rpt.Site = Me.Site
        Return rpt
    End Function
