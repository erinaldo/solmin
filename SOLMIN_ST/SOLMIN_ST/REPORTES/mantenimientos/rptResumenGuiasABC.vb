...
Public Class rptResumenGuiasABC
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SOLMIN_ST.rptResumenGuiasABC.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptResumenGuiasABC
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptResumenGuiasABC = New rptResumenGuiasABC()
        rpt.Site = Me.Site
        Return rpt
    End Function
