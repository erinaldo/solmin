...
Public Class rptIndicadorWAP
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SOLMIN_ST.rptIndicadorWAP.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptIndicadorWAP
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptIndicadorWAP = New rptIndicadorWAP()
        rpt.Site = Me.Site
        Return rpt
    End Function
