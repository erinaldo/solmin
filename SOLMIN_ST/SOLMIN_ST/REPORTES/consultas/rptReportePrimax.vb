...
Public Class rptReportePrimax
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SOLMIN_ST.rptReportePrimax.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptReportePrimax
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptReportePrimax = New rptReportePrimax()
        rpt.Site = Me.Site
        Return rpt
    End Function
