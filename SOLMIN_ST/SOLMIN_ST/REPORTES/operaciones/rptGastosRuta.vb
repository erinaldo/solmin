...
Public Class rptGastosRuta
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SOLMIN_ST.rptGastosRuta.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptGastosRuta
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptGastosRuta = New rptGastosRuta()
        rpt.Site = Me.Site
        Return rpt
    End Function
