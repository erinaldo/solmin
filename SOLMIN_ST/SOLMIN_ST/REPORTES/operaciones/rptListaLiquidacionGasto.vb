...
Public Class rptListaLiquidacionGasto
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptListaLiquidacionGasto.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SOLMIN_ST.rptListaLiquidacionGasto.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptListaLiquidacionGasto
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptListaLiquidacionGasto = New rptListaLiquidacionGasto()
        rpt.Site = Me.Site
        Return rpt
    End Function
