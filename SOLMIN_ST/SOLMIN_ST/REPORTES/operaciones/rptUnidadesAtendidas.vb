...
Public Class rptUnidadesAtendidas
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptUnidadesAtendidas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptUnidadesAtendidas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptUnidadesAtendidas = New rptUnidadesAtendidas
        rpt.Site = Me.Site
        Return rpt
    End Function
