...
Public Class rptPlanRuta_Viaje
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SOLMIN_ST.rptPlanRuta_Viaje.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPlanRuta_Viaje
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPlanRuta_Viaje = New rptPlanRuta_Viaje()
        rpt.Site = Me.Site
        Return rpt
    End Function
