...
Public Class rptLiquidacionGasto
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptLiquidacionGasto.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SOLMIN_ST.rptLiquidacionGasto.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptLiquidacionGasto
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptLiquidacionGasto = New rptLiquidacionGasto()
        rpt.Site = Me.Site
        Return rpt
    End Function
