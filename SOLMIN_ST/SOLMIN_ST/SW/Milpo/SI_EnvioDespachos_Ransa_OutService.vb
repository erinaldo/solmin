...
Namespace Milpo.Despacho
    ...
    Partial Public Class SI_EnvioDespachos_Ransa_OutService
        ...
        Public Sub New()
            ...
            '    "Y_MILPO_RANSA&senderService=BC_RANSA_SERVICES_QA&receiverParty=&receiverService="& _ 
            '    "&interface=SI_EnvioDespachos_Ransa_Out&interfaceNamespace=http%3A%2F%2Fvm.milpo."& _ 
            '    "ransa.enviodespachos"
            Dim Milpo As New RutaMilpo
            Me.Credentials = New System.Net.NetworkCredential(Milpo.Usuario, Milpo.Clave)
            Me.Url = Milpo.RutaServerMilpo
            Me.Timeout = 600000
    ...
    Partial Public Class DT_EnvioDespachos
        ...
        Public Property TRACTO() As String
            Get
                Return Me.tRACTOField
            End Get
            Set
                Me.tRACTOField = value
            End Set
        End Property
