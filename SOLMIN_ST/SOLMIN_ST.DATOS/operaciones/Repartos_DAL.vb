  ...
  Public Class Repartos_DAL
    ...
    Public Function Listar_Operaciones_Reparto(ByVal objParametros As List(Of String)) As List(Of Repartos)
      ...
      Dim objParam As New Parameter
            ...
            objDataTable = objSql.ExecuteDataTable("SP_SOLMIN_ST_LISTAR_OP_REPARTO_V2", objParam)
            ...
            For Each objData As DataRow In objDataTable.Rows
                ...
                objDatos.CPLNDV = objData("CPLNDV").ToString.Trim
                objDatos.TPLNTA = objData("TPLNTA").ToString.Trim
                'OMVB REQ30072019 CONSULTAS CON SELECCIÓN DE PLANTAS
    ...
    Public Function Exportar_Factura_Reparto(ByVal objEntidad As Hashtable) As DataTable
      ...
      Dim objParam As New Parameter
            ...
            objDataTable = objSql.ExecuteDataTable("SP_SOLMIN_ST_EXPORTAR_FACTURA_REPARTO_1", objParam)
