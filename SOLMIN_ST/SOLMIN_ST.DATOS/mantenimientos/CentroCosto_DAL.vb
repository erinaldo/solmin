  ...
  Public Class CentroCosto_DAL
    ...
    Public Function Listar_Centro_Costo(ByVal objEntidad As CentroCosto) As List(Of CentroCosto)
      ...
      Return objGenericCollection
        ...
        Public Function Listar_Centro_Costo_Alquiler(ByVal objEntidad As CentroCosto) As List(Of CentroCosto)
            Dim objDataTable As New DataTable
            Dim objGenericCollection As New List(Of CentroCosto)
            Dim objParam As New Parameter
            ...
            'Obteniendo resultados
            objSql.DefaultSchema = Autenticacion_DAL.GetLibrary(objEntidad.CCMPN)
            objDataTable = objSql.ExecuteDataTable("SP_SOLMIN_ST_LISTAR_CENTRO_COSTO_ALQUILER", objParam)
