...
Namespace localhost
    ...
    Partial Public Class SolminWeb
        ...
        Public Sub New()
            MyBase.New
            Me.Url = Global.SOLMIN_ST.NEGOCIO.My.MySettings.Default.SOLMIN_ST_NEGOCIO_localhost_SolminWeb
        ...
        Public Function GuardarImagen(ByVal Imagen As Object, ByVal Nombre As String, ByVal Carpeta As String) As Boolean
            Dim results() As Object = Me.Invoke("GuardarImagen", New Object() {Imagen, Nombre, Carpeta})
            Return CType(results(0),Boolean)
        End Function
        
        '''<remarks/>
        Public Overloads Sub GuardarImagenAsync(ByVal Imagen As Object, ByVal Nombre As String, ByVal Carpeta As String)
            Me.GuardarImagenAsync(Imagen, Nombre, Carpeta, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub GuardarImagenAsync(ByVal Imagen As Object, ByVal Nombre As String, ByVal Carpeta As String, ByVal userState As Object)
