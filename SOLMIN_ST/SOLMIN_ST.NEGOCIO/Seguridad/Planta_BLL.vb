...
Public Class Planta_BLL
    ...
    Private oDt As List(Of ENTIDADES.Mantenimientos.ClaseGeneral)
    ...
    Public Function Lista_Planta(ByVal pdblCodCompania As String, ByVal pdblCodDivision As String) As List(Of ENTIDADES.Mantenimientos.ClaseGeneral)
